...
const JOURNALISTS = [
 ...
 {id:"j3",name:"Yasmine Kadi",role:"Correspondante",spec:"Moyen-Orient & conflits",init:"YK",live:true,gender:"F",premium:false},
...
const EVENTS_DATA:EventItem2[] = [
 // JUIN 2026
 {id:1,date:"2",month:"JUN",day:"Mar",title:"Forum Méditerranée & Diplomatie",loc:"Palais du Pharo, Marseille",type:"Forum",lat:43.2947,lng:5.3614,attendees:284,mode:" Présentiel",desc:"Forum annuel sur la diplomatie méditerranéenne et les relations euro-africaines."},
 ...
 {id:4,date:"7",month:"JUN",day:"Dim",title:"Rencontres Géopolitiques d'Aix-en-Provence",loc:"Sciences Po Aix, Aix-en-Provence",type:"Forum",lat:43.5297,lng:5.4474,attendees:412,mode:" Présentiel",desc:"3 jours de conférences sur les grands enjeux géopolitiques mondiaux."},
 {id:5,date:"9",month:"JUN",day:"Mar",title:"Model United Nations — Sciences Po Paris",loc:"Sciences Po Paris",type:"Simulation",lat:48.8517,lng:2.3294,attendees:320,mode:" Présentiel",desc:"Simulation du Conseil de sécurité et de l'Assemblée générale de l'ONU."},
 ...
 {id:7,date:"12",month:"JUN",day:"Ven",title:"Forum Économique : L'Euro à l'heure des tensions géopolitiques",loc:"Palais Brongniart, Paris",type:"Forum",lat:48.8649,lng:2.3424,attendees:580,mode:" Présentiel"},
 {id:8,date:"14",month:"JUN",day:"Dim",title:"Concours d'éloquence Sciences Po Bordeaux",loc:"Sciences Po Bordeaux",type:"Concours",lat:44.8378,lng:-0.5792,attendees:140,mode:" Présentiel"},
 ...
 {id:14,date:"20",month:"JUN",day:"Sam",title:"Hackathon IA & Diplomatie — Sciences Po Paris",loc:"Sciences Po Paris",type:"Hackathon",lat:48.8517,lng:2.3294,attendees:200,mode:" Présentiel"},
 ...
 {id:17,date:"24",month:"JUN",day:"Mer",title:"Sommet franco-allemand — Relations bilatérales",loc:"Élysée, Paris",type:"Sommet",lat:48.8698,lng:2.3160,attendees:150,mode:" Présentiel"},
 ...
 {id:24,date:"3",month:"JUL",day:"Ven",title:"Forum de Paris sur la Paix — Session d'été",loc:"Grande Halle de la Villette, Paris",type:"Forum",lat:48.8929,lng:2.3920,attendees:1400,mode:" Présentiel"},
 {id:25,date:"6",month:"JUL",day:"Lun",title:"Simulation ONU mondiale — NMUN New York",loc:"New York, USA",type:"Simulation",lat:40.7489,lng:-73.9680,attendees:5000,mode:" Présentiel"},
 ...
 {id:29,date:"13",month:"JUL",day:"Lun",title:"Sommet de l'OTAN — Réunion des chefs d'État",loc:"Bruxelles, Belgique",type:"Sommet",lat:50.8503,lng:4.3517,attendees:400,mode:" Présentiel"},
 {id:30,date:"14",month:"JUL",day:"Mar",title:"Défilé du 14 juillet — Fête Nationale française",loc:"Champs-Élysées, Paris",type:"Commémoration",lat:48.8698,lng:2.3078,attendees:400000,mode:" Présentiel"},
 ...
 {id:36,date:"24",month:"JUL",day:"Ven",title:"Conférence internationale : Sécurité en Méditerranée",loc:"Rome, Italie",type:"Conférence",lat:41.9028,lng:12.4964,attendees:600,mode:" Présentiel"},
 ...
 // AOÛT 2026
 {id:40,date:"3",month:"AOÛ",day:"Lun",title:"Conférence d'été de l'Institut des Relations Internationales",loc:"Grenoble",type:"Conférence",lat:45.1885,lng:5.7245,attendees:220,mode:" Présentiel"},
 ...
 {id:52,date:"31",month:"AOÛ",day:"Lun",title:"Conférence : Mémoire de la Résistance — 80 ans de la Libération",loc:"Musée de l'Armée, Paris",type:"Commémoration",lat:48.8549,lng:2.3124,attendees:300,mode:" Présentiel"},
 // SEPTEMBRE 2026
 ...
 {id:55,date:"5",month:"SEP",day:"Sam",title:"Concours d'éloquence inter-universitaire — Île-de-France",loc:"Sorbonne, Paris",type:"Concours",lat:48.8488,lng:2.3426,attendees:280,mode:" Présentiel"},
 ...
 {id:68,date:"28",month:"SEP",day:"Lun",title:"Conférence sur les armes chimiques — OIAC",loc:"La Haye, Pays-Bas",type:"Conférence",lat:52.0705,lng:4.3007,attendees:700,mode:" Présentiel"},
 ...
 {id:82,date:"23",month:"OCT",day:"Ven",title:"Forum sur la liberté de la presse — RSF",loc:"Paris",type:"Forum",lat:48.8566,lng:2.3522,attendees:400,mode:" Présentiel",link:"https://rsf.org"},
 ...
 {id:92,date:"11",month:"NOV",day:"Mer",title:"Commémoration de l'Armistice — Cérémonie Arc de Triomphe",loc:"Paris, France",type:"Commémoration",lat:48.8738,lng:2.2950,attendees:100000,mode:" Présentiel"},
 ...
 {id:95,date:"17",month:"NOV",day:"Mar",title:"Conférence internationale des juristes — Droit pénal",loc:"La Haye, Pays-Bas",type:"Conférence",lat:52.0705,lng:4.3007,attendees:700,mode:" Présentiel"},
 ...
 {id:98,date:"21",month:"NOV",day:"Sam",title:"Conférence francophone sur l'éloquence et la rhétorique",loc:"Lyon, France",type:"Conférence",lat:45.7640,lng:4.8357,attendees:250,mode:" Présentiel"},
...
const ELOQUENCE_TEXTS:EloquenceEntry[]=[
 // DISCOURS
 {id:"eq1",title:"Le Sursaut — Style discours de résistance",author:"Texte original NEXUS · inspiré de De Gaulle",category:"discours",level:"intermediaire",duration:"~45s",text:"Il est des heures dans l'histoire\noù un peuple doit choisir.\n\nChoisir entre la résignation\net le sursaut.\n\nEntre le silence\net la parole.\n\n\nNous avons choisi.\n\nNous avons choisi de ne pas nous incliner.\nNous avons choisi de continuer.\nNous avons choisi la liberté.\n\n\nCar notre nation ne se réduit pas à un territoire.\nElle n'est pas seulement une armée.\nElle est une idée.\nEt les idées ne capitulent pas.\n\n\nAussi longtemps qu'un seul homme,\nqu'une seule femme sur notre sol\nrefusera la défaite,\nnous n'aurons pas capitulé.\n\n\nNous continuons.\nNous résistons.\nNous vaincrons."},
 {id:"eq2",title:"Discours pour la dignité des femmes — Style politique",author:"Texte original NEXUS · style discours parlementaire",category:"discours",level:"expert",duration:"~50s",text:"Permettez-moi de vous parler d'abord\nen tant que femme.\n\nCar c'est en tant que femme\nque je comprends ce dont il est question ici.\n\n\nIl s'agit de la vie des femmes.\nDe leur liberté.\nDe leur dignité.\n\n\nPersonne ne peut décider à leur place\nde ce qu'elles peuvent supporter,\nde ce qu'elles peuvent assumer,\nde ce qu'elles ont le droit de choisir.\n\n\nLes lois ne font pas les mœurs.\nElles les reconnaissent.\nOu elles les ignorent.\nEt quand elles les ignorent,\nles femmes ne s'arrêtent pas pour autant.\nElles souffrent.\nSeules.\nEt en silence.\n\n\nCe silence,\nnous n'avons pas le droit\nde le laisser continuer."},
 {id:"eq3",title:"Discours inaugural — Style réconciliation nationale",author:"Texte original NEXUS · style discours inaugural",category:"discours",level:"intermediaire",duration:"~40s",text:"Nous sommes enfin debout.\n\nAprès des décennies de nuit,\nle soleil se lève sur notre peuple.\n\n\nCe soleil ne s'est pas levé tout seul.\nIl a fallu des milliers d'hommes et de femmes\npour le porter jusqu'à l'horizon.\n\nCertains ont tout donné.\nLeur liberté.\nLeur famille.\nLeur vie.\n\n\nNous leur devons de ne pas gâcher\nce qu'ils ont conquis.\n\n\nNous construirons une nation\noù aucun enfant ne grandira dans la honte.\nOù aucune famille ne vivra dans la peur.\nOù chaque voix comptera.\nChaque voix sans exception.\n\n\nC'est notre promesse.\nC'est notre honneur.\nC'est notre avenir."},
 ...
 {id:"eq6",title:"Proclamation de liberté — Style discours d'indépendance",author:"Texte original NEXUS · style discours de libération",category:"discours",level:"intermediaire",duration:"~45s",text:"Frères et sœurs,\nenfants de notre terre,\n\n\nce jour est le vôtre.\n\nNon pas le mien.\nNon pas celui du gouvernement.\n\nLe vôtre.\n\n\nVous l'avez attendu.\nVous l'avez espéré.\nCertains parmi vous ont lutté toute leur vie\npour voir ce jour.\n\n\nAujourd'hui nous sommes libres.\nLibres de choisir.\nLibres de bâtir.\nLibres d'échouer et de recommencer.\n\nLibres.\n\n\nEt cette liberté,\nnous ne la rendrons jamais.\n\n\nVive notre peuple libre !\nVive notre terre souveraine !"},
 ...
 // LITTÉRATURE
 {id:"eq16",title:"La condition humaine — Style absurde",author:"Texte original NEXUS · style Camus",category:"litterature",level:"intermediaire",duration:"~40s",text:"Nous vivons tous dans l'attente de quelque chose.\n\nUne lettre qui n'arrive pas.\nUn mot qui n'est pas dit.\nUne vérité que l'on reporte à demain.\n\n\nEt demain ressemble à aujourd'hui.\nEt aujourd'hui ressemble à hier.\n\n\nL'homme se lève.\nIl travaille.\nIl mange.\nIl dort.\nIl recommence.\n\n\nEt pourtant, dans certains soirs,\nquelque chose se fissure.\nUne question monte.\n\nPourquoi ?\n\n\nCe n'est pas une question mélancolique.\nC'est une question vivante.\nLa plus vivante de toutes.\n\nCar celui qui cesse de se la poser\na cessé, dans un sens,\nd'être pleinement vivant."},
 ...
 {id:"eq21",title:"La liberté et le regard — Style existentialiste",author:"Texte original NEXUS · style Sartre",category:"litterature",level:"intermediaire",duration:"~35s",text:"Nous ne sommes jamais seuls avec nous-mêmes.\n\nL'autre est toujours là.\nDans notre regard.\nDans notre pensée.\n\n\nDans ce que nous choisissons d'être\nou de ne pas être.\n\n\nLa liberté, c'est une chose étrange.\nOn la veut absolue.\nEt elle nous arrive toujours limitée.\n\nLimitée par le regard de l'autre.\nLimitée par nos propres peurs.\nLimitée par le monde tel qu'il est.\n\n\nMais peut-être que c'est dans ces limites\nque se joue l'essentiel.\n\nCe que je choisis de faire\nmalgré les limites,\nmalgré les regards,\nmalgré la peur,\n\nc'est cela qui me définit.\nPas mes intentions.\nMes actes."},
 {id:"eq22",title:"L'indifférence du monde — Style absurde",author:"Texte original NEXUS · style Camus",category:"litterature",level:"debutant",duration:"~30s",text:"Ce matin, rien n'avait changé.\n\nEt pourtant tout était différent.\n\n\nLa même rue.\nLes mêmes visages.\nLe même ciel blanc.\n\n\nMais quelque chose dans ma façon de regarder\navait bougé pendant la nuit.\n\nComme si la colle invisible\nqui tenait ensemble les choses et leur sens\ns'était dissoute.\n\n\nLes choses étaient là.\nSimplement là.\nSans explication.\n\nEt j'étais là aussi.\nSimpleme là.\nEn train de les regarder.\n\n\nJe me suis demandé si c'était de la tristesse.\n\nNon.\nC'était autre chose.\nPlus calme.\nPlus profond."},
 ...
 {id:"eq35",title:"Souviens-toi ce matin — Style poésie quotidienne",author:"Texte original NEXUS · style Prévert",category:"poesie",level:"debutant",duration:"~50s",text:"Souviens-toi ce matin\nil pleuvait sur la ville\net tu marchais\n\n\nLes rues brillaient\ncomme des miroirs mouillés\net tu regardais le ciel\n\n\nJe t'ai vu de loin\nje n'ai pas osé te parler\ntu souriais\n\n\nMaintenant la ville est la même\nles rues brillent encore quand il pleut\nmais tu n'es plus là\n\n\nEt quand il pleut sur la ville\nje pense à ce matin\net à ce sourire\n\nEt à tout ce que je n'ai pas dit"},
 ...
 {id:"eq40",title:"Terre mère — Style négritude",author:"Texte original NEXUS · style Senghor",category:"poesie",level:"intermediaire",duration:"~45s",text:"Terre ronde, terre mère,\nenveloppée de nuit douce,\n\n\nje t'entends respirer.\n\nTes enfants dorment\nsur ta poitrine immense.\nIls rêvent de rivières,\nde manguiers,\nde feux qui brûlent dans la nuit.\n\n\nTu les tiens tous.\nLes anciens et les vivants.\nCeux qui sont partis\net ceux qui reviendront.\n\n\nTerre ronde, terre mère,\ntu nous rappelles\nque nous venons de toi\net que nous y retournerons.\n\n\nEt entre les deux,\nil y a la vie.\nToute la vie."},
 {id:"eq41",title:"Parole libre — Style poésie engagée",author:"Texte original NEXUS · style Césaire",category:"poesie",level:"expert",duration:"~40s",text:"Ma bouche sera ma liberté.\n\nNon pas la liberté qu'on m'accorde.\nNon pas la liberté qu'on me concède.\n\n\nLa liberté que je prends.\nQue je forge.\nQue je crie.\n\n\nParce que ma bouche connaît des mots\nque personne ne m'a appris.\nDes mots venus du fond des âges.\nDes mots que la mer a portés.\n\n\nParce que ma voix n'est pas seulement ma voix.\nC'est la voix de tous ceux\nqui n'ont pas eu le droit de parler.\n\n\nAlors je parle.\nJe parle pour eux.\nJe parle pour moi.\n\nJe parle."},
 {id:"eq42",title:"Le combat des frères — Style poésie de résistance",author:"Texte original NEXUS · style Aragon",category:"poesie",level:"intermediaire",duration:"~45s",text:"Celui qui avait perdu tout espoir\nmarchait encore dans la nuit\n\n\nCelui qui n'attendait plus rien\ntendait encore les mains dans l'obscurité\n\n\nIls ne se connaissaient pas\nl'un croyait au lendemain\nl'autre n'y croyait plus\n\n\nMais dans la même nuit\nils marchaient dans le même sens\nvers la même lumière\n\n\nEt quand le matin vint\nils se trouvèrent côte à côte\nsans savoir comment\n\n\nC'est ainsi que la fraternité travaille\nsans bruit sans gloire\ndans les nuits les plus longues"},
 ...
 // DISCOURS LONGS — 4 à 5 minutes
 {id:"eq63",title:"Grand discours de résistance — Style gaullien · 4 min",author:"Texte original NEXUS · style discours de résistance",category:"discours",level:"intermediaire",duration:"~4 min",text:"Français, Françaises,\n\n\nUn gouvernement a cédé.\nUne armée a plié.\nUn territoire a été envahi.\n\n\nMais une nation ne meurt pas\nparce qu'un gouvernement capitule.\n\nUne nation ne meurt pas\nparce que son armée est défaite.\n\nUne nation vit\ntant qu'un seul de ses enfants\nrefuse de mourir à genoux.\n\n\nNous ne mourrons pas à genoux.\n\n\nCeux qui ont signé la défaite\nn'avaient pas le droit de le faire.\nCar la nation ne leur appartient pas.\nLa nation nous appartient.\nÀ nous tous.\nÀ chacun d'entre nous.\n\n\nEt tant que nous respirons,\ntant que nous pensons,\ntant que nous pouvons lever la voix,\nla bataille n'est pas terminée.\n\n\nNous avons des alliés.\nNous avons des ressources.\nNous avons ce que aucune armée ne peut capturer :\nnous avons notre volonté.\n\n\nJe m'adresse à tous ceux qui peuvent entendre cette voix.\n\nOfficiers.\nSoldats.\nOuvriers.\nIngénieurs.\nHommes et femmes de bonne volonté.\n\n\nRejoingnez le combat.\nNe restez pas dans l'attente.\nL'attente est une forme de complicité.\n\n\nChaque jour qui passe sans résistance\nest un jour donné à l'ennemi.\n\nChaque jour de résistance\nest un jour volé à l'oppression.\n\n\nLa flamme ne s'éteindra pas.\nJe vous en fais la promesse.\n\nElle brûlera\ntant qu'il restera un homme debout\npour la porter.\n\n\nEt ces hommes debout,\nce sont vous.\nC'est nous.\nC'est la France.\n\n\nVive la résistance.\nVive la liberté.\nVive notre peuple uni et debout."},
 {id:"eq64",title:"Discours sur la misère — Assemblée nationale",author:"Victor Hugo",category:"discours",level:"expert",duration:"~5 min",text:"Messieurs,\n\nLorsque la question de la misère\nest posée avec toute sa gravité,\ntoute son étendue et toutes ses conséquences,\n\n\nje suis de ceux qui pensent\nqu'on peut détruire la misère.\n\nNotez bien ces mots : détruire la misère.\nOui, en civilisant,\nen moralisant,\nen instruisant,\non peut détruire la misère.\n\n\nLégislateurs et gouvernants,\nvotre mission, votre devoir,\nc'est de faire en sorte\nqu'il n'y ait pas dans votre pays,\nperdu dans des hameaux obscurs,\ndans des faubourgs malsains,\nun seul homme, une seule femme,\nun seul enfant,\nqui souffre de la faim,\nqui souffre du froid,\nqui manque d'une école,\nqui manque d'un toit.\n\n\nVoilà la question sociale.\nEt je dis qu'en France, en 1849,\nla question sociale peut être résolue.\n\n\nMais pour cela,\nil faut que ceux qui gouvernent le veuillent.\nIl faut que ceux qui légifèrent le veuillent.\nIl faut que le pays entier le veuille.\n\n\nJe ne veux pas vous faire un tableau de la misère.\nVous la connaissez.\nLes chiffres parlent.\n\nDes millions de Français\nne mangent pas à leur faim.\nDes millions de Français\nne savent pas lire.\nDes millions de Français\nn'ont pas d'abri décent.\n\n\nEst-ce que c'est la fatalité ?\nNon.\nC'est une injustice.\n\nEst-ce que c'est inévitable ?\nNon.\nC'est évitable.\n\n\nLa société peut agir.\nLa société doit agir.\nLa société n'a pas le droit de ne pas agir.\n\n\nComment ?\nPar l'instruction d'abord.\nOuvrez des écoles.\nFermez des prisons.\nC'est le même combat.\n\nPar le travail ensuite.\nDonnez à tout homme\nla possibilité de travailler.\nPayez-le justement.\nNe le laissez pas mourir d'épuisement\npour gagner de quoi ne pas mourir de faim.\n\n\nPar la solidarité enfin.\nNe laissez pas les hommes seuls\nface à la maladie,\nface à la vieillesse,\nface aux accidents de la vie.\n\n\nMessieurs,\nce que je vous demande,\nce n'est pas la charité.\nC'est la justice.\n\nLa charité humilie.\nLa justice élève.\n\n\nJe terminerai par ceci :\n\nUn peuple ne peut être grand\nque si tous ses membres sont libres.\nUn peuple ne peut être libre\nque si tous ses membres sont dignes.\nUn peuple ne peut être digne\nque si aucun d'entre eux ne souffre de misère.\n\n\nVoilà pourquoi détruire la misère,\nc'est construire la grandeur de la France.\n\n\nJe vous en supplie.\nAgissez."},
 {id:"eq65",title:"Discours pour la dignité et la liberté des femmes · 5 min",author:"Texte original NEXUS · style discours politique féminin",category:"discours",level:"expert",duration:"~5 min",text:"Mesdames, Messieurs,\n\n\nJe vous parle en tant que femme.\n\nPas en tant que ministre.\nPas en tant que parlementaire.\n\nEn tant que femme.\n\n\nEt je vous dis quelque chose de simple.\n\nQuand on légifère sur la vie des femmes,\non devrait d'abord écouter les femmes.\n\n\nJe les ai écoutées.\nPendant des années.\nDes dizaines.\nDes centaines de femmes.\n\nJ'ai entendu leurs histoires.\nLeurs peurs.\nLeurs silences.\nLeurs douleurs.\n\n\nEt ce que j'ai compris,\nce que je dois vous dire aujourd'hui,\nc'est que la loi ne doit pas ajouter\nde la souffrance à la souffrance.\n\n\nNous parlons de situations de détresse.\n\nDes femmes seules.\nDes femmes sans ressources.\nDes femmes sans soutien.\nDes femmes qui ont peur.\n\n\nCes femmes ne choisissent pas par légèreté.\nElles ne choisissent pas de gaieté de cœur.\n\nElles choisissent parce qu'elles sont au bout.\nParce qu'elles ne voient pas d'autre issue.\nParce que personne n'est là pour les aider.\n\n\nEt que fait la loi actuelle ?\n\nElle les condamne.\nSans les aider.\nElle les laisse seules.\nDans le danger.\nDans la clandestinité.\n\n\nCela doit cesser.\n\n\nNous n'avons pas à choisir\nentre la morale et la compassion.\nLa vraie morale,\nc'est la compassion.\n\nLa vraie éthique,\nc'est de ne pas abandonner\nceux qui souffrent.\n\n\nJe ne vous demande pas d'approuver.\nJe ne vous demande pas d'aimer ce texte.\n\nJe vous demande d'être humains.\n\n\nD'être à la hauteur de ce que ces femmes\nattendent de vous.\n\nDe cette Assemblée.\nDe cette République.\n\n\nLa République ne peut pas laisser\nses filles mourir en silence.\n\n\nC'est pourquoi je vous demande de voter ce texte.\n\nNon pour moi.\nPour elles.\n\n\nToutes celles qui n'ont pas de voix ici.\nToutes celles qui attendent, dehors,\nque vous décidiez de leur sort.\n\n\nSoyez à la hauteur.\n\n\nJe vous remercie."},
 {id:"eq66",title:"Discours pour la Paix — Version longue",author:"Jean Jaurès",category:"discours",level:"expert",duration:"~4 min",text:"Citoyens,\n\nla guerre, si elle éclatait,\nserait le plus grand crime de l'histoire.\n\nNon pas parce que la guerre serait sans cause.\nMais parce qu'elle aurait des causes misérables\npour des conséquences incalculables.\n\n\nDes millions d'hommes vont mourir.\nDes millions d'hommes vont souffrir.\nDes millions de familles vont être brisées.\n\nPour quoi ?\nPour des rivalités de chancelleries.\nPour des intérêts commerciaux.\nPour des orgueils nationaux.\n\n\nLes peuples ne veulent pas la guerre.\nLes peuples ne l'ont jamais voulue.\nCe sont les gouvernements qui font les guerres.\nCe sont les peuples qui les subissent.\n\n\nVoici ce que je vous demande,\ntravailleurs de tous les pays,\ncitoyens de toutes les nations :\n\nRefusez.\nRefusez la guerre.\nRefusez d'y participer.\nRefusez de la financer.\nRefusez de la glorifier.\n\n\nOn vous dira que c'est votre devoir.\nOn vous dira que c'est l'honneur national.\nOn vous dira que vos frères qui refusent sont des lâches.\n\n\nMais moi je vous dis\nque le vrai courage,\nc'est de dire non.\n\nQue la vraie force,\nc'est la solidarité entre les peuples.\n\nQue le vrai patriotisme,\nc'est d'aimer son pays assez\npour ne pas le précipiter dans un bain de sang inutile.\n\n\nNous avons une responsabilité collective.\nLes syndicats ouvriers,\nles partis socialistes,\nles hommes de bonne volonté de tous les pays,\nnous pouvons arrêter cette folie.\n\n\nSi nous agissons ensemble.\nSi nous parlons d'une seule voix.\nSi nous disons non,\nd'un seul mouvement,\nd'un seul cœur.\n\n\nCar la paix n'est pas l'absence de guerre.\nLa paix, c'est la justice entre les nations.\nLa paix, c'est le respect mutuel entre les peuples.\nLa paix, c'est le règlement pacifique des conflits.\n\n\nEt cette paix est possible.\nElle est possible aujourd'hui.\nElle est possible si nous le voulons.\n\n\nAlors je vous en supplie :\nvoulez-la.\nVoulez-la de toutes vos forces.\nVoulez-la avant qu'il soit trop tard.\n\n\nCar demain,\nil sera peut-être trop tard."},
 {id:"eq67",title:"Discours d'indépendance africaine · 4 min",author:"Texte original NEXUS · style discours de libération",category:"discours",level:"intermediaire",duration:"~4 min",text:"Mes frères, mes sœurs,\nenfants de cette terre,\n\n\nce jour est unique.\n\nJamais plus nous ne vivrons un tel jour.\nCar un tel jour ne se vit qu'une fois.\nLe jour où un peuple reprend son destin.\n\n\nVous avez attendu ce moment.\nVos parents l'ont attendu.\nLes parents de vos parents l'ont attendu.\n\nCertains sont morts sans le voir.\n\nCeux-là,\nnous devons nous souvenir d'eux aujourd'hui.\nNous leur devons ce moment.\n\n\nL'indépendance n'est pas un cadeau.\nElle ne se donne pas.\nElle ne se négocie pas à genoux.\n\nElle se conquiert.\nPar le courage.\nPar la résistance.\nPar la solidarité entre un peuple.\n\n\nNous l'avons conquise ensemble.\nPersonne ne peut nous la reprendre.\n\n\nMais voici ce que je dois vous dire.\n\nL'indépendance n'est que le premier pas.\nLe plus dur commence maintenant.\n\nNous devons prouver\nque nous sommes capables de nous gouverner.\nQue nous pouvons bâtir des institutions justes.\nQue nous pouvons créer une économie\nqui profite à tous,\npas seulement à quelques-uns.\n\n\nNous devons construire des écoles.\nOuvrir des hôpitaux.\nTracer des routes.\nFaire pousser nos champs.\nFormer nos enfants.\n\n\nCe travail est immense.\nJe ne vous le cache pas.\n\nMais c'est notre travail.\nPersonne ne le fera à notre place.\nEt personne n'a le droit de le faire à notre place.\n\n\nDes adversaires viendront.\nDes voix diront que nous avons besoin de tuteurs.\nQue nous ne sommes pas prêts.\nQue l'indépendance était une erreur.\n\n\nNe les écoutez pas.\n\nUn peuple est toujours prêt à être libre.\nUn peuple est toujours capable de se gouverner.\n\nCela s'apprend.\nComme tout s'apprend.\nPar l'effort.\nPar l'erreur.\nPar la persévérance.\n\n\nJe vous fais cette promesse :\nnotre gouvernement vous appartiendra.\nIl gouvernera pour vous.\nIl rendra des comptes.\nIl sera honnête.\n\n\nEt si jamais il trahissait cette promesse,\nvous aurez le droit de le renvoyer.\nCar le pouvoir vient du peuple.\nIl y retourne toujours.\n\n\nVive notre peuple libre !\nVive notre terre souveraine !\nVive l'Afrique debout !"},
 {id:"eq68",title:"Grand oral Sciences Po — Modèle complet",author:"Exercice de concours",category:"discours",level:"expert",duration:"~5 min",text:"Monsieur le Président du jury,\nMesdames et Messieurs les membres du jury,\n\n\nLa question qui m'a été soumise est fondamentale\npour comprendre le monde dans lequel nous vivons.\n\nJe vais tenter d'y répondre avec la rigueur\nque vous êtes en droit d'attendre,\nla sincérité que j'essaie d'apporter\ndans toute réflexion sérieuse,\net l'ouverture d'esprit\nqui caractérise — je l'espère — ma génération.\n\n\nPremièrement,\nposons le cadre.\n\nNous vivons dans un monde multipolaire.\nLes grandes puissances s'affrontent.\nLes démocraties libérales sont sous pression.\nLes crises — climatique, économique, géopolitique —\nse superposent et s'alimentent mutuellement.\n\nDans ce contexte,\nla question de la gouvernance mondiale\nn'est plus théorique.\nElle est urgente.\n\n\nDeuxièmement,\nexaminons les faits.\n\nLes institutions internationales héritées de 1945\nbattent de l'aile.\nLe Conseil de sécurité est paralysé.\nL'OMC est en crise.\nL'Accord de Paris est insuffisamment appliqué.\n\nCe n'est pas le signe que le multilatéralisme a échoué.\nC'est le signe qu'il doit être profondément réformé.\n\n\nTroisièmement,\nproposons des solutions.\n\nJe pense que la réforme du multilatéralisme\npasse par trois axes.\n\nPremier axe : la représentativité.\nLe Sud global doit avoir une voix au chapitre.\nL'Afrique, l'Asie du Sud, l'Amérique latine\nreprésentent la majorité de la population mondiale.\nElle doit être représentée en proportion.\n\nDeuxième axe : l'efficacité.\nMoins de consensus obligatoire.\nPlus de majorité qualifiée.\nMoins de veto paralysants.\nPlus de décisions opérationnelles.\n\nTroisième axe : la légitimité démocratique.\nLes citoyens du monde doivent pouvoir s'identifier\naux institutions qui les gouvernent.\nCela suppose transparence,\naccountability,\net participation civique à l'échelon international.\n\n\nJe suis conscient que ces propositions\nsont ambitieuses.\nJe suis conscient qu'elles se heurtent\nà des intérêts nationaux puissants.\n\n\nMais je crois que la génération qui arrive,\nma génération,\ncelle qui a grandi avec le dérèglement climatique\ncomme donnée de base,\ncelle qui pense en réseau,\ncelle qui n'a pas peur des frontières,\n\ncette génération est prête\nà penser autrement.\n\n\nEt c'est à vous,\nà vous qui formez les décideurs de demain,\nde nous en donner les moyens.\n\n\nJe vous remercie de votre attention.\nJe suis prêt pour vos questions."},
 {id:"eq69",title:"Plaidoirie de défense — Procès pour la liberté",author:"Exercice de barreau",category:"discours",level:"expert",duration:"~5 min",text:"Monsieur le Président,\nMesdames et Messieurs les jurés,\n\n\nJe n'ai jamais autant senti le poids de ma responsabilité\nqu'en ce moment.\n\nDevant vous se joue une vie.\nDevant vous se joue une liberté.\nDevant vous se joue une vérité.\n\n\nMon client est innocent.\n\nJe ne vous demande pas de me croire sur parole.\nJe vous demande d'écouter les preuves.\nJe vous demande d'écouter les faits.\nJe vous demande d'écouter votre raison.\n\n\nL'accusation vous a présenté un scénario séduisant.\nUn scénario cohérent.\nUn scénario convaincant en apparence.\n\nMais la séduction n'est pas la vérité.\nLa cohérence interne d'un récit\nn'en prouve pas la réalité.\n\n\nVoici ce que l'accusation n'a pas pu prouver.\n\nPremièrement,\nle mobile.\nOn vous a dit que mon client avait une raison d'agir.\nMais une raison supposée n'est pas un mobile prouvé.\nDes millions de gens ont de supposées raisons chaque jour.\nIls n'agissent pas.\n\nDeuxièmement,\nl'opportunité.\nOn vous a dit qu'il était présent ce soir-là.\nMais présent ne signifie pas coupable.\nDes centaines de personnes étaient présentes.\nPourquoi lui ?\n\nTroisièmement,\nles preuves matérielles.\nOù sont-elles ?\nL'accusation s'est appuyée sur des témoignages\ncertainement sincères mais potentiellement erronés,\nsur des présomptions,\nsur des suppositions.\n\nPas sur des preuves.\n\n\nLe droit pénal repose sur un principe fondateur :\nla présomption d'innocence.\n\nCe n'est pas une formalité.\nCe n'est pas une technicité juridique.\nC'est le fondement de toute société libre.\n\nSi nous condamnons sur des présomptions,\nnous ouvrons la porte à l'arbitraire.\nNous ouvrons la porte à l'erreur judiciaire.\nNous ouvrons la porte à la barbarie légalisée.\n\n\nMon client a une femme.\nIl a des enfants.\nIl a une vie.\nCette vie ne doit pas être détruite\nsur la base de suppositions.\n\n\nJe ne vous demande pas de le plaindre.\nJe ne vous demande pas de l'aimer.\nJe vous demande de l'acquitter.\n\nParce que la justice le commande.\nParce que les preuves l'imposent.\nParce que votre conscience,\nle soir venu,\nquand vous serez seuls avec vous-mêmes,\nvous dira que vous avez eu raison.\n\n\nC'est tout ce que je vous demande.\n\nLa vérité.\nRien que la vérité."},
 {id:"eq70",title:"Discours sur la jeunesse et l'avenir",author:"Discours inaugural modèle",category:"discours",level:"intermediaire",duration:"~4 min",text:"Mesdames, Messieurs,\nchères amies,\nchers amis,\n\n\nVous savez pourquoi nous sommes réunis ici.\n\nNon pas pour célébrer le passé,\nbien qu'il mérite d'être honoré.\n\nNon pas pour commenter le présent,\nbien qu'il appelle notre attention.\n\nMais pour imaginer l'avenir.\nEt pour décider ensemble de le construire.\n\n\nL'avenir n'est pas une donnée.\nL'avenir est un choix.\n\nChaque génération qui passe\nlaisse derrière elle un héritage.\nCet héritage peut être une promesse tenue.\nOu une promesse trahie.\n\n\nQuel héritage allons-nous laisser ?\n\nJe vous pose la question sincèrement.\nNon par rhétorique.\nMais parce que je crois\nque c'est la bonne question.\nLa seule qui compte vraiment.\n\n\nNous vivons une époque de basculement.\nLe monde d'avant ne reviendra pas.\nLe monde de demain n'est pas encore dessiné.\n\nNous sommes dans l'entre-deux.\nDans l'inconfort de la transition.\nDans la douleur et l'excitation de la naissance d'un monde nouveau.\n\n\nCela fait peur.\nBien sûr.\nTout changement profond fait peur.\n\nMais la peur n'est pas une stratégie.\nLa nostalgie n'est pas un programme.\nLe repli sur soi n'est pas une solution.\n\n\nAlors que faire ?\n\nS'engager.\nPrend le sens fort du terme.\nS'engager corps et âme.\nS'engager avec ses compétences,\navec son temps,\navec sa passion.\n\n\nLes problèmes que nous affrontons sont immenses.\nLe dérèglement climatique.\nLes inégalités croissantes.\nLes fractures démocratiques.\n\nMais chaque grand problème de l'histoire de l'humanité\na été résolu par des hommes et des femmes\nqui ont refusé de capituler.\n\n\nRefusez de capituler.\n\n\nParce que vous en avez la capacité.\nParce que vous en avez l'intelligence.\nParce que vous en avez la jeunesse.\n\nEt parce que si vous ne le faites pas,\npersonne ne le fera à votre place.\n\n\nMerci."},
 {id:"eq71",title:"Femme noire — Hommage à l'Afrique",author:"Inspiré de Léopold Sédar Senghor",category:"discours",level:"intermediaire",duration:"~4 min",text:"Mesdames, Messieurs,\n\n\nJe veux vous parler ce soir de l'Afrique.\n\nNon pas l'Afrique des clichés.\nNon pas l'Afrique de la pitié.\nNon pas l'Afrique des catastrophes.\n\n\nL'Afrique vivante.\nL'Afrique debout.\nL'Afrique qui pense,\nqui crée,\nqui invente.\n\n\nL'Afrique qui est le berceau de l'humanité.\nL'Afrique qui a vu naître les premières civilisations.\nL'Afrique qui a inventé l'écriture,\nl'astronomie,\nla philosophie.\n\n\nPendant des siècles,\non vous a dit que l'Afrique était pauvre.\nOn vous a dit qu'elle était arriérée.\nOn vous a dit qu'elle avait besoin d'aide.\n\n\nOn a oublié de vous dire\nqu'elle avait été pillée.\nOn a oublié de vous dire\nqu'elle avait été exploitée.\nOn a oublié de vous dire\nque sa pauvreté avait une cause humaine\net donc une solution humaine.\n\n\nL'Afrique ne demande pas la pitié.\nElle demande la justice.\n\nElle ne demande pas l'aide.\nElle demande la réciprocité.\n\nElle ne demande pas votre condescendance.\nElle demande votre respect.\n\n\nCar l'Afrique est un continent de jeunesse.\nLa moitié de sa population a moins de vingt-cinq ans.\nImaginez cette énergie.\nImaginez cette créativité.\nImaginez ce potentiel.\n\n\nLe XXIe siècle sera africain\nou il ne sera pas.\n\n\nEt pour que ce siècle soit africain dans le bon sens,\nil faut des leaders courageux.\nIl faut des institutions solides.\nIl faut une jeunesse éduquée et engagée.\nIl faut la coopération d'un monde\nqui reconnaît enfin l'Afrique pour ce qu'elle est :\n\n\nNon pas un problème à résoudre.\nMais une opportunité à saisir.\nUn partenaire à respecter.\nUne civilisation à honorer.\n\n\nVive l'Afrique.\nVive la dignité des peuples.\nVive la liberté pour tous."},
 // LONGS — LITTÉRATURE
 {id:"eq72",title:"Les Misérables — L'âme de Jean Valjean",author:"Victor Hugo",category:"litterature",level:"expert",duration:"~4 min",text:"Ce que Jean Valjean avait subi dans Toulon\nn'était pas la souffrance du corps.\nC'était la souffrance de l'âme.\n\n\nDix-neuf ans de bagnes.\nDix-neuf ans d'humiliations.\nDix-neuf ans à entendre dire :\ntu n'es rien.\ntu ne seras jamais rien.\ntu es une bête,\npas un homme.\n\n\nEt peu à peu,\nJean Valjean avait fini par le croire.\n\nPeu à peu,\nla chaleur humaine en lui s'était éteinte.\nPeu à peu,\nla colère avait remplacé la tendresse.\nPeu à peu,\nla haine avait remplacé l'amour.\n\n\nMais dans la nuit de Digne,\nquelque chose s'était produit.\n\nUn évêque lui avait ouvert sa porte.\nUn évêque l'avait appelé son hôte.\nUn évêque lui avait dit :\ntu es mon frère.\n\n\nEt Jean Valjean avait volé les chandeliers.\n\nEt l'évêque avait menti pour lui.\nEt l'évêque lui avait dit :\nJean Valjean,\nces chandeliers,\nje vous les donne.\nMais je les donne\nnon pas à la bête qui était dans les fers.\nJe les donne à l'homme libre que vous allez devenir.\n\n\nCet instant.\nCet instant seul.\nAvait tout changé.\n\n\nCar voilà le mystère de l'âme humaine.\n\nElle peut être broyée.\nElle peut être avilie.\nElle peut être presque anéantie.\n\nMais il suffit d'un geste de bonté sincère,\nd'un regard qui dit tu as de la valeur,\nd'une voix qui dit tu es un homme,\n\npour que quelque chose se rallume.\nQuelque chose d'indestructible.\nQuelque chose d'éternel.\n\n\nVictor Hugo appelait cela la conscience.\nD'autres l'appellent la grâce.\nD'autres encore l'appellent simplement l'humanité.\n\n\nQuel que soit son nom,\nne l'éteignez jamais chez l'autre.\nNe la laissez pas s'éteindre en vous.\n\n\nC'est tout le sens de ce roman.\nC'est tout le sens de notre vie."},
 // LONGS — PRATIQUE
 {id:"eq73",title:"Exercice de grande éloquence — 5 minutes",author:"Entraînement avancé",category:"pratique",level:"expert",duration:"~5 min",text:"Cet exercice est conçu pour les orateurs avancés.\nIl dure cinq minutes.\nIl travaille l'endurance,\nla respiration,\nle rythme,\net la conviction sur la longueur.\n\n\nPARTIE I — L'entrée en matière.\n\nCommencez lentement.\nInstallez votre présence.\nLaissez le silence travailler pour vous.\n\nReguardez votre public.\nPrenez le temps.\nNe soyez pas pressé d'avoir raison.\n\n\nLe public ne s'appartient pas avant trois minutes.\nAvant trois minutes,\nil vous évalue.\nIl se demande : vaut-il la peine que je l'écoute ?\n\nVotre rôle,\ndans ces premières minutes,\nc'est de répondre : oui.\n\n\nPARTIE II — Le développement.\n\nMaintenant vous pouvez avancer.\nVous avez gagné leur attention.\nNe la dilapidez pas.\n\nChaque mot compte.\nChaque pause compte.\nChaque variation de voix compte.\n\n\nParlez plus vite sur les détails.\nParlez plus lentement sur les idées fortes.\nParlez plus bas pour les confidences.\nParlez plus fort pour les convictions.\n\n\nUtilisez le silence comme un outil.\nUn silence de deux secondes après une affirmation forte\nvaut mieux que dix mots de plus.\n\n\nPARTIE III — La montée en puissance.\n\nVous approchez de la fin.\nVotre énergie doit croître.\nPas diminuer.\n\nC'est là que beaucoup d'orateurs se perdent.\nIls s'essoufflent.\nIls accélèrent par nervosité.\nIls perdent le fil.\n\nVous, vous respirez.\nVous, vous ralentissez.\nVous, vous ancrez.\n\n\nLes trois dernières minutes d'un grand discours\nsont les plus importantes.\nCe sont elles dont on se souvient.\n\n\nAlors donnez tout ce que vous avez.\nDonnez votre conviction.\nDonnez votre énergie.\nDonnez votre vérité.\n\n\nPARTIE IV — La conclusion.\n\nLa conclusion se prépare dès le début.\nElle ne surgit pas.\nElle arrive.\nComme une évidence.\nComme un aboutissement.\n\n\nQuand vous dites votre dernier mot,\nfaites une pause.\nLongue.\nTrès longue.\n\n\nPuis inclinez légèrement la tête.\nEt attendez.\n\n\nCar le plus grand silence d'un orateur,\nc'est celui qui suit ses derniers mots.\n\nC'est lui qui dit :\nj'ai terminé.\nJ'ai tout donné.\nC'était pour vous."},
];
...
const DEMO_PROFILES = [
 ...
 {id:"dp3",name:"Chiara Romano",init:"CR",role:"Chercheuse en relations internationales",location:"Rome",verified:false,color:"#7C3AED",followers:890,bio:"Sciences Po Paris · LUISS Roma",story:{type:"photo",caption:"En vacances à Athènes — ville berceau de la démocratie ",bg:"linear-gradient(135deg,#7C3AED,#E03535)"}},
 ...
 {id:"dp15",name:"Omar Diallo",init:"OD",role:"Avocat pénaliste international",location:"La Haye",verified:true,color:"#E03535",followers:1950,bio:"CPI · Tribunal pénal international",story:{type:"video",caption:"Intervention à la CPI — affaire en cours, commentaires sous embargo jusqu'au verdict ",bg:"linear-gradient(135deg,#E03535,#2B78F5)"}},
 ...
 {id:"dp28",name:"Béatrice Nzinga",init:"BN",role:"Chercheuse panafricanisme",location:"Kinshasa",verified:false,color:"#7C3AED",followers:670,bio:"UNIKIN · Héritage Lumumba · Panafricanisme",story:{type:"photo",caption:"À Kinshasa pour commémorer les 65 ans de l'assassinat de Lumumba ",bg:"linear-gradient(135deg,#7C3AED,#D97706)"}},
 ...
 {id:"dp30",name:"Diana Pham",init:"DP",role:"Avocate droit international pénal",location:"Genève",verified:true,color:"#E03535",followers:2400,bio:"CPI · Crimes de guerre · Droit humanitaire",story:{type:"video",caption:"Retour sur mon plaidoyer à la CPI — pourquoi ce procès est historique ",bg:"linear-gradient(135deg,#E03535,#16A34A)"}},
];
...
VÉRIFIÉ (80-100): faits exacts et vérifiables. PROBABLE (60-79): cohérent mais non prouvé. DOUTEUX (30-59): contradictions ou manque de preuves. NON VÉRIFIÉ (0-29): sans source ou invérifiable.`,
 ...
 {st.type==="philosophe"&&<span style={{marginLeft:"auto",background:"rgba(124,58,237,.7)",color:"#fff",fontSize:10,padding:"3px 8px",borderRadius:8,fontWeight:700}}> PHILOSOPHIE</span>}
 ...
 {st.type==="proverbe"?"Proverbe":st.type==="philosophe"?"Philosophie":st.type==="auteur"?"Littérature":"Sagesse"}
 </p>
 </>
 ):(
 <>
...
const OPPORTUNITIES_DATA:Opportunity[]=[
 ...
 {id:20,title:"Stage CPI — Juriste international",org:"Cour Pénale Internationale",orgEmoji:"",type:"Stage",domain:"Droit pénal international",location:"La Haye, Pays-Bas",zone:"Europe",duration:"6 mois",link:"https://www.icc-cpi.int/vacancies",desc:"Stage à la CPI. Bureau du Procureur, Chambre préliminaire, section Victimes. Master Droit requis."},
 {id:21,title:"Stage CIJ — Cour internationale de Justice",org:"CIJ (ICJ)",orgEmoji:"",type:"Stage",domain:"Droit international public",location:"La Haye, Pays-Bas",zone:"Europe",duration:"3 mois",link:"https://www.icj-cij.org/internship",desc:"Stage à la CIJ. Recherche juridique sur les affaires inter-étatiques. Master Droit international requis."},
 {id:22,title:"Stage CEDH — Cour européenne des droits de l'homme",org:"CEDH / Conseil de l'Europe",orgEmoji:"",type:"Stage",domain:"Droits de l'homme / Droit",location:"Strasbourg",zone:"Europe",duration:"3 mois",link:"https://www.echr.coe.int/internships",desc:"Stage à la CEDH. Filtrage des requêtes, rédaction de documents juridiques. En français ou anglais."},
 {id:23,title:"Stage Mécanisme Résiduel TPIY/TPIR",org:"MICT (ONU)",orgEmoji:"",type:"Stage",domain:"Droit pénal international",location:"La Haye / Arusha",zone:"Monde",duration:"3–6 mois",link:"https://www.irmct.org/en/jobs/internships",desc:"Stage au Mécanisme pour les Tribunaux pénaux de l'ONU. Recherche sur les crimes de guerre, génocides."},
 {id:24,title:"Stage Tribunal de l'Union européenne",org:"Tribunal UE (CJUE)",orgEmoji:"",type:"Stage",domain:"Droit européen",location:"Luxembourg",zone:"Europe",duration:"5 mois",link:"https://curia.europa.eu/jcms/jcms/Jo2_7008/",desc:"Stage au Tribunal de l'UE (contentieux administratif). Assistance aux juges, rédaction de notes juridiques."},
 {id:25,title:"Stage Cour de Justice de l'UE",org:"CJUE",orgEmoji:"",type:"Stage",domain:"Droit européen",location:"Luxembourg",zone:"Europe",duration:"5 mois",link:"https://curia.europa.eu/jcms/jcms/Jo2_7008/",desc:"Stage au cabinet des juges ou avocats généraux de la CJUE. Excellent niveau en droit de l'UE requis."},
 ...
 {id:29,title:"Stage Conseil de l'Europe",org:"Conseil de l'Europe",orgEmoji:"",type:"Stage",domain:"Droits de l'homme / Démocratie",location:"Strasbourg",zone:"Europe",duration:"3 mois",link:"https://www.coe.int/en/web/jobs/traineeships",desc:"500 stages/an au Conseil de l'Europe. Droits de l'homme, démocratie, état de droit."},
 {id:30,title:"Stage APCE — Assemblée parlementaire",org:"Conseil de l'Europe",orgEmoji:"",type:"Stage",domain:"Politique / Droit",location:"Strasbourg",zone:"Europe",duration:"3 mois",link:"https://www.coe.int/en/web/jobs/traineeships",desc:"Stage à l'Assemblée parlementaire du Conseil de l'Europe. Commissions thématiques, résolutions, rédaction de rapports."},
 {id:31,title:"Stage OTAN",org:"OTAN",orgEmoji:"",type:"Stage",domain:"Défense / RI / Cyber",location:"Bruxelles",zone:"Europe",duration:"3–6 mois",link:"https://www.nato.int/cps/en/natohq/85562.htm",desc:"Stages dans les divisions OTAN (opérations, communication, cyber). Pour ressortissants des pays membres."},
 ...
 {id:38,title:"Stage Assemblée Nationale — Collaborateur·rice",org:"Assemblée Nationale",orgEmoji:"",type:"Stage",domain:"Politique / Législatif",location:"Paris",zone:"France",duration:"3–6 mois",link:"https://www.assemblee-nationale.fr/stages",desc:"Stage auprès d'un·e député·e ou dans les services de l'AN. Suivi législatif, recherche, relations publiques."},
 {id:39,title:"Stage Sénat — Commission des affaires étrangères",org:"Sénat",orgEmoji:"",type:"Stage",domain:"RI / Droit",location:"Paris",zone:"France",duration:"3 mois",link:"https://www.senat.fr/stage.html",desc:"Stage dans les services du Sénat. Direction européenne, commission des affaires étrangères, défense."},
 ...
 {id:92,title:"Juriste — Cour de Justice de l'UE",org:"CJUE",orgEmoji:"",type:"Emploi",domain:"Droit européen",location:"Luxembourg",zone:"Europe",link:"https://curia.europa.eu/jcms/jcms/Jo2_7231/",desc:"Poste de juriste-linguiste ou référendaire. Rédaction d'arrêts, de conclusions d'avocat général, recherche juridique."},
 ...
 {id:99,title:"Rédacteur·rice — Assemblée Nationale",org:"Assemblée Nationale",orgEmoji:"",type:"Emploi",domain:"Politique / Administration",location:"Paris",zone:"France",link:"https://www.assemblee-nationale.fr/recrutement",desc:"Concours de fonctionnaire de l'AN. Postes de rédacteurs, administrateurs, documentalistes. Travail en commissions parlementaires."},
 {id:100,title:"Administrateur·rice — Sénat",org:"Sénat",orgEmoji:"",type:"Emploi",domain:"Droit / Administration / RI",location:"Paris",zone:"France",link:"https://www.senat.fr/senatrecrutement.html",desc:"Concours d'administrateur du Sénat. Suivi législatif, recherche juridique, commissions (Affaires étrangères, Défense, Europe)."},
 // EMPLOIS ONG & THINK TANKS 
 {id:101,title:"Chargé·e de programme — Amnesty International",org:"Amnesty International",orgEmoji:"",type:"Emploi",domain:"Droits de l'homme / Plaidoyer",location:"Paris / Londres",zone:"Europe",link:"https://www.amnesty.fr/rejoignez-nous",desc:"Gestion de campagnes sur des thématiques (torture, peine de mort, droits des femmes). Plaidoyer, relations médias, enquête."},
 ...
 {id:106,title:"Greffier·ère adjoint·e — CPI",org:"Cour Pénale Internationale",orgEmoji:"",type:"Emploi",domain:"Droit pénal international",location:"La Haye, Pays-Bas",zone:"Europe",link:"https://www.icc-cpi.int/vacancies",desc:"Soutien administratif et juridique au Greffe de la CPI. Gestion des victimes, témoins, dossiers judiciaires. Master Droit."},
 ...
 {id:108,title:"Greffier·ère — CEDH",org:"CEDH / Conseil de l'Europe",orgEmoji:"",type:"Emploi",domain:"Droits de l'homme / Droit",location:"Strasbourg",zone:"Europe",link:"https://www.echr.coe.int/vacancies",desc:"Traitement des requêtes individuelles, rédaction de communications, assistance aux chambres de jugement. Master Droit requis."},
 // EMPLOIS ORGANISATIONS RÉGIONALES 
 {id:109,title:"Analyste politique — OTAN",org:"OTAN",orgEmoji:"",type:"Emploi",domain:"Défense / Sécurité / RI",location:"Bruxelles",zone:"Europe",link:"https://www.nato.int/cps/en/natohq/85600.htm",desc:"Analyse des menaces, rédaction de documents politiques pour les ambassadeurs OTAN. Requis : Master + expérience sécurité."},
 ...
 {id:130,title:"Stage mairie / collectivité — Mission internationale",org:"Mairies & Métropoles",orgEmoji:"",type:"Stage",domain:"Coopération / Relations internationales",location:"France entière",zone:"France",duration:"3–6 mois",link:"https://www.emploi-territorial.fr",desc:"Stage dans les services RI des grandes villes françaises (Paris, Lyon, Marseille, Bordeaux). Coopération décentralisée, diplomatie des villes."},
 ...
 // PHYSIQUE / SCIENCES 
 {id:140,title:"Chercheur·se — CERN (Organisation européenne)",org:"CERN",orgEmoji:"",type:"Emploi",domain:"Physique des particules / Sciences",location:"Genève, Suisse",zone:"Europe",link:"https://careers.cern.ch",desc:"Postes scientifiques et techniques au CERN (accélérateur LHC). Physique des hautes énergies, ingénierie, informatique quantique."},
 {id:141,title:"Stage CERN — Physique & Ingénierie",org:"CERN",orgEmoji:"",type:"Stage",domain:"Physique / Informatique / Ingénierie",location:"Genève, Suisse",zone:"Europe",duration:"4–6 mois",link:"https://careers.cern.ch/students",desc:"Stage au CERN ouvert aux étudiants en physique, informatique, ingénierie. Participation aux expériences LHC (ATLAS, CMS, etc.)."},
...
const DISCOURS_DATA=[
 ...
 {id:17,title:"Discours sur les libertés - Nobel",speaker:"Albert Camus",year:"1957",country:"",theme:"Littérature & engagement",excerpt:"Camus réinterprète la mission de sa génération d'après-guerre : incapable de refaire le monde comme ses prédécesseurs l'espéraient, elle porte la tâche peut-être plus grande encore d'empêcher que le monde ne s'effondre.",techniques:["Paradoxe générationnel","Éthos de l'artiste","Pathos existentiel","Humilité épique"],context:"Prononcé à Stockholm le 10 décembre 1957 lors de la remise du Prix Nobel de Littérature. Camus, alors âgé de 44 ans, évoque sa génération marquée par la Seconde Guerre mondiale, l'Occupation et la Résistance.",analysis:"Camus construit un paradoxe frappant : la grandeur d'une génération incapable de 'refaire le monde' réside précisément dans sa résistance au chaos. L'humilité épique — reconnaître les limites pour mieux affirmer la tâche — est une figure rhétorique rare. Sa prose littéraire donne au discours une densité poétique qui transcende l'occasion."},
 {id:18,title:"Discours I am an African",speaker:"Thabo Mbeki",year:"1996",country:"",theme:"Identité africaine",excerpt:"Mbeki revendique une identité africaine plurielle et inclusive, embrassant tous ses héritages — Khoisan, esclavage, colonisation — pour construire une définition de l'africanité qui transcende les clivages raciaux de l'apartheid.",techniques:["Identité plurielle","Anaphore identitaire","Pathos historique","Inclusion"],context:"Prononcé le 8 mai 1996 lors de l'adoption de la Constitution post-apartheid de l'Afrique du Sud, ce discours incarne la vision d'une 'Rainbow Nation' plurielle et réconciliée que Mbeki défend en tant que vice-président.",analysis:"Mbeki construit une identité africaine inclusive par accumulation — chaque couche historique (colonisation, esclavage, résistance) enrichit plutôt qu'elle ne divise. L'anaphore 'Je suis africain' crée une identité rhétorique ouverte à tous les héritages. C'est une réponse poétique à l'apartheid qui divisait l'humanité en catégories raciales."},
 {id:19,title:"Discours de Harlem - contre la guerre du Vietnam",speaker:"Malcolm X",year:"1964",country:"",theme:"Droits civiques",excerpt:"Malcolm X opère une redéfinition radicale de l'identité noire américaine : en se proclamant victimes plutôt que citoyens, il reframe entièrement le rapport au pays pour justifier une posture de résistance affirmée.",techniques:["Redéfinition sémantique","Logos radical","Rupture identitaire","Urgence"],context:"Prononcé en 1964 lors d'une réunion publique à Harlem, Malcolm X s'oppose à l'intégrationnisme de King et prône l'auto-défense et l'autonomie noire. Ce discours illustre la radicalisation du mouvement des droits civiques.",analysis:"Malcolm X utilise une redéfinition rhétorique puissante : en renommant les Noirs américains 'victimes' plutôt que 'citoyens', il reframe le problème politique entier. Cette stratégie sémantique lui permet de justifier une posture défensive plus radicale. La logique est implacable même si les conclusions sont controversées."},
 {id:20,title:"Discours de Mexico - He for She",speaker:"Emma Watson",year:"2014",country:"",theme:"Féminisme",excerpt:"Watson propose une définition inclusive du féminisme centrée sur l'égalité politique, économique et sociale entre les sexes, pour désarmer les réticences et inviter les hommes à rejoindre le mouvement.",techniques:["Redéfinition inclusive","Éthos de la célébrité","Logos définitionnel","Appel à l'universel"],context:"Prononcé le 20 septembre 2014 au siège de l'ONU à New York, Emma Watson, actrice et ambassadrice de bonne volonté pour ONU Femmes, lance la campagne 'HeForShe' invitant les hommes à s'engager pour l'égalité des genres.",analysis:"Watson commence par une redéfinition stratégique du féminisme pour désarmer la résistance masculine au terme. Son éthos de célébrité est délibérément mis au service de la cause plutôt que de sa propre image. Elle construit un logos inclusif : le féminisme comme mouvement universel bénéficiant à tous les genres."},
 {id:21,title:"Discours de Pretoria à sa sortie de prison",speaker:"Nelson Mandela",year:"1994",country:"",theme:"Réconciliation",excerpt:"Mandela prononce une triple promesse solennelle que l'Afrique du Sud ne connaîtra jamais plus l'oppression, transformant son discours d'investiture en clôture définitive et poétique de l'ère de la ségrégation.",techniques:["Triple anaphore","Hyperbole temporelle","Vision utopique","Clôture solennelle"],context:"Discours d'investiture du 10 mai 1994 à Pretoria, Mandela devient le premier président noir d'Afrique du Sud après les premières élections multiraciales. C'est la conclusion historique de 350 ans d'oppression raciale institutionnalisée.",analysis:"Mandela emploie une triple anaphore 'jamais, jamais et jamais encore' qui fait écho à son discours de 1964 mais cette fois comme proclamation victorieuse plutôt que comme engagement. L'hyperbole solaire ('le soleil ne se couchera plus') élève le moment au rang de mythe fondateur. Le discours est construit comme une clôture historique."},
 {id:22,title:"Discours du Che à l'ONU",speaker:"Ernesto Che Guevara",year:"1964",country:"",theme:"Impérialisme",excerpt:"Che Guevara articule un paradoxe sur la révolution : autonome par nature et non exportable par décret, sa flamme est cependant contagieuse et ne s'arrête pas aux frontières des États.",techniques:["Logos révolutionnaire","Paradoxe","Éthos du combattant","Internationalisme"],context:"Prononcé le 11 décembre 1964 à l'Assemblée générale des Nations Unies, le Che Guevara représente Cuba et dénonce l'impérialisme américain et la politique de l'apartheid. Le discours est prononcé en pleine Guerre froide, après la crise des missiles de Cuba (1962).",analysis:"Le Che construit un paradoxe rhétorique sur l'exportabilité de la révolution pour affirmer simultanément l'autonomie de chaque peuple et la solidarité internationale. Son éthos de guerrier qui a combattu au Congo et en Bolivie renforce la crédibilité d'un discours sur la lutte armée. La franchise provocatrice face à l'auditoire diplomatique est elle-même un acte rhétorique."},
 ...
 {id:24,title:"Discours à l'ONU - Olive Branch",speaker:"Yasser Arafat",year:"1974",country:"",theme:"Droits nationaux",excerpt:"Arafat présente sa démarche comme l'union de la diplomatie et de la résistance armée, symbolisées par l'olivier et le fusil, et supplie l'Assemblée de ne pas laisser la branche de paix lui être arrachée.",techniques:["Symbolisme de l'olivier","Métaphore des deux mains","Paradoxe guerre/paix","Appel dramatique"],context:"Prononcé le 13 novembre 1974 à l'Assemblée générale de l'ONU, Arafat est le premier représentant d'une organisation non gouvernementale invité à s'exprimer devant l'assemblée. L'OLP vient d'être reconnue comme seul représentant légitime du peuple palestinien.",analysis:"Arafat construit une métaphore visuelle puissante des deux mains — l'olivier de la paix et le fusil de la résistance — qui condense la dialectique de la lutte armée et de la diplomatie. La mise en scène de sa propre personne comme symbole vivant est une stratégie d'éthos corporel rare. Son appel final constitue une injonction directe à l'Assemblée."},
 {id:25,title:"Sankara - Discours à l'OUA",speaker:"Thomas Sankara",year:"1987",country:"",theme:"Dette africaine",excerpt:"Sankara dénonce la dette africaine comme un mécanisme de néocolonialisme déguisé en aide financière, appelant les dirigeants africains à en percevoir la nature politique avant même la nature économique.",techniques:["Logos économique radical","Métaphore de la reconquête","Urgence rhétorique","Interpellation directe"],context:"Prononcé à Addis-Abeba en juillet 1987 lors du sommet de l'Organisation de l'Unité Africaine, six mois avant son assassinat. Sankara, président révolutionnaire du Burkina Faso depuis 1983, propose que les pays africains refusent collectivement de rembourser leur dette.",analysis:"Sankara réinterprète la dette financière comme instrument de domination politique — une analyse qui préfigure les théories contemporaines sur le néocolonialisme économique. Sa rhétorique directe et imagée ('reconquête savamment organisée') transforme un débat technocratique en mobilisation politique. L'interpellation brutale à ses homologues africains est une stratégie de honte collective."},
 {id:26,title:"Discours de Moscou - Harvey Milk",speaker:"Harvey Milk",year:"1978",country:"",theme:"Droits LGBTQ+",excerpt:"Milk retourne ironiquement l'accusation de recrutement portée contre la communauté LGBT+ en l'acceptant avec humour pour en révéler l'absurdité : ils recrutent des enfants pour les aimer dans leurs familles.",techniques:["Ironie retournée","Humour politique","Éthos du témoin","Inversion du stigmate"],context:"Prononcé en 1978 à San Francisco, Harvey Milk, premier élu ouvertement gay des États-Unis, s'adresse à ses partisans lors d'une célébration du Gay Freedom Day. Il sera assassiné la même année.",analysis:"Milk emploie une stratégie rhétorique de l'ironie retournée : en acceptant ironiquement l'accusation de 'recrutement', il la vide de son sens et révèle son absurdité. L'humour politique permet de désarmer la peur. Son éthos de témoin — il parle de ce qu'il a vécu — donne une authenticité irremplaçable à sa défense des droits LGBTQ+."},
 {id:27,title:"Discours sur la tolérance",speaker:"Václav Havel",year:"1990",country:"",theme:"Démocratie",excerpt:"Havel appelle chaque citoyen tchécoslovaque à reconnaître sa propre responsabilité dans la complicité passive avec le régime, préférant la réconciliation par l'examen de conscience à la revanche contre les anciens oppresseurs.",techniques:["Responsabilité collective","Logos moral","Éthos du dissident","Métaphore de la purification"],context:"Prononcé lors du discours du Nouvel An de 1990, Havel s'adresse à la Tchécoslovaquie comme premier président post-communiste après la Révolution de velours. Il a été emprisonné plusieurs fois pour dissidence sous le régime communiste.",analysis:"Havel opère un renversement moral : plutôt que d'accabler les anciens oppresseurs, il invite chaque citoyen à examiner sa propre complicité passive. Cette rhétorique de la responsabilité partagée prépare la réconciliation nationale. Son éthos de dissident qui refuse la revanche lui donne une autorité morale exceptionnelle pour ce discours de refondation."},
 {id:28,title:"Discours Nobel de la Paix",speaker:"Mother Teresa",year:"1979",country:"",theme:"Pauvreté",excerpt:"Mère Teresa identifie l'avortement comme le plus grave obstacle à la paix dans le monde contemporain, une position controversée illustrant comment une autorité morale immense peut porter des arguments profondément débattus.",techniques:["Éthos de la sainteté","Paradoxe choquant","Provocation délibérée","Témoignage direct"],context:"Prononcé à Oslo le 10 décembre 1979, Mother Teresa, fondatrice des Missionnaires de la Charité à Calcutta, reçoit le Prix Nobel de la Paix pour son travail auprès des plus démunis. Son discours provoque une controverse immédiate.",analysis:"Mother Teresa utilise son éthos immense de 'sainte des bidonvilles' pour avancer des positions controversées. La provocation rhétorique — relier avortement et destruction de la paix — illustre comment l'autorité morale peut légitimer des arguments difficiles. Ce discours montre les limites et la puissance de l'éthos comme ressource rhétorique."},
 {id:29,title:"Discours du Moi suis président",speaker:"Malala Yousafzai",year:"2013",country:"",theme:"Éducation",excerpt:"Malala décrit comment la tentative d'assassinat a produit l'effet inverse de celui recherché par ses agresseurs : loin de la briser, l'attentat a renforcé sa conviction et sa détermination à se battre pour l'éducation des filles.",techniques:["Antithèse mort/naissance","Éthos du survivant","Pathos du courage","Vision universelle"],context:"Prononcé le 12 juillet 2013 à l'ONU à New York, jour de son 16e anniversaire, Malala Yousafzai, rescapée d'une tentative d'assassinat par les talibans au Pakistan, plaide pour le droit universel à l'éducation.",analysis:"Malala transforme son attentat personnel en argument universel : la tentative d'assassin a produit l'effet inverse de celui recherché. L'antithèse mort/naissance (faiblesse/courage) structure un récit de renaissance qui transcende sa propre histoire pour devenir métaphore d'une génération entière. Son jeune âge renforce paradoxalement son autorité."},
 {id:30,title:"Discours COP21 - Notre maison brûle",speaker:"Greta Thunberg",year:"2019",country:"",theme:"Climat",excerpt:"Thunberg interpelle directement les dirigeants mondiaux en les accusant d'avoir sacrifié l'avenir des jeunes générations à des promesses vides, décrivant les souffrances humaines et écologiques comme conséquences de leur inaction.",techniques:["Interpellation directe","Pathos de la jeunesse","Accusation morale","Anaphore de la douleur"],context:"Prononcé le 23 septembre 2019 au Sommet Action Climat de l'ONU à New York, Greta Thunberg, alors âgée de 16 ans, s'adresse directement aux dirigeants mondiaux lors de son discours le plus viral.",analysis:"Thunberg rompt délibérément avec le registre diplomatique — 'comment osez-vous ?' est une interpellation frontale sans précédent dans une enceinte internationale. Sa stratégie rhétorique repose entièrement sur le pathos de la génération future sacrifiée. L'accusation directe sans argument alternatif force les auditeurs à se positionner moralement."},
 {id:31,title:"Discours à la Rada ukrainienne",speaker:"Volodymyr Zelensky",year:"2022",country:"",theme:"Résistance",excerpt:"Zelensky confirme sa présence à Kiev le lendemain de l'invasion russe, démentant les rumeurs de fuite et affirmant la résolution ukrainienne à défendre le pays, élevant la vérité au rang d'arme.",techniques:["Presence physique comme argument","Conviction simple","Éthos du courage","Logos de la légitimité"],context:"Prononcé le 25 février 2022, le lendemain de l'invasion russe à grande échelle de l'Ukraine, Zelensky répond aux rumeurs de fuite en enregistrant une vidéo depuis les rues de Kiev avec ses collaborateurs.",analysis:"Zelensky transforme sa présence physique à Kiev en argument rhétorique central : rester est en soi le discours. Le logos minimal ('nos armes sont la vérité') associé au contexte dramatique crée un impact maximal. Ce discours illustre comment le contexte peut amplifier des mots simples jusqu'à l'épique."},
 ...
 {id:37,title:"Discours de Berlin - Ich bin ein Berliner",speaker:"Konrad Adenauer",year:"1950",country:"",theme:"Réconciliation",excerpt:"Adenauer oriente délibérément l'Allemagne d'après-guerre vers l'intégration européenne plutôt que vers le passé, substituant une vision continentale à l'identité nationale compromise par le nazisme.",techniques:["Vision européenne","Rupture avec le passé","Logos pragmatique","Projection temporelle"],context:"Prononcé lors de sa politique de réconciliation franco-allemande après 1949, Adenauer, premier chancelier de la RFA, oriente délibérément l'Allemagne d'après-guerre vers l'intégration européenne plutôt que vers la revendication nationaliste.",analysis:"Adenauer emploie une rhétorique du futur délibéré pour tourner la page du nazisme sans le nier : la projection vers l'Europe sert de substitut positif à l'identité nationale problématique. C'est une rhétorique de substitution où l'idéal européen remplace le nationalisme blessé. Sa sobriété oratoire est elle-même politique."},
 ...
 {id:39,title:"Discours Nobel - Liberté de la presse",speaker:"Maria Ressa",year:"2021",country:"",theme:"Liberté de la presse",excerpt:"Ressa construit un syllogisme logique en cascade pour démontrer que les attaques contre les faits détruisent successivement la vérité, la confiance et finalement toute réalité partagée nécessaire à la démocratie.",techniques:["Syllogisme en cascade","Logos de la vérité","Éthos de journaliste persécutée","Urgence démocratique"],context:"Prononcé le 10 décembre 2021 à Oslo lors de la remise du Prix Nobel de la Paix, Maria Ressa, cofondatrice de Rappler aux Philippines, fait face à plusieurs procès pour ses enquêtes sur le régime de Duterte.",analysis:"Ressa construit un syllogisme rhétorique en cascade — faits, vérité, confiance, réalité — qui démontre logiquement que la liberté de la presse est la condition de la démocratie. Son éthos de journaliste poursuivie par un gouvernement autoritaire donne une dimension existentielle à un argument théorique. La concision logique est saisissante."},
 {id:40,title:"Discours You are not Forgotten",speaker:"Barack Obama",year:"2009",country:"",theme:"Diplomatie",excerpt:"Obama propose un nouveau départ fondé sur la réciprocité et le respect mutuel avec le monde musulman, annonçant une rupture diplomatique avec l'approche unilatérale américaine des années précédentes.",techniques:["Rhétorique de l'inclusion","Logos interculturel","Éthos de l'ouverture","Vision multilatérale"],context:"Prononcé le 4 juin 2009 au Caire, Égypte, devant une audience de 3 000 personnes, ce discours marque le pivot diplomatique d'Obama vers le monde islamique après les années Bush. Obama cite le Coran et reconnaît les torts historiques américains.",analysis:"Obama emploie une rhétorique de la réciprocité — 'intérêt mutuel et respect mutuel' — pour signaler une rupture avec l'unilatéralisme américain. La citation du Coran par un président américain est un acte rhétorique interculturel sans précédent. L'éthos de l'homme au nom arabe qui reconnaît les erreurs américaines crée une crédibilité inédite dans le monde musulman."},
 // PREMIUM DISCOURS 
 ...
 {id:46,premium:true,title:"Ich bin ein Berliner",speaker:"John F. Kennedy",year:"1963",country:"",theme:"Liberté",excerpt:"Kennedy compare la solidarité avec Berlin-Ouest à la fierté de l'ancienne citoyenneté romaine, affirmant que dans le monde libre contemporain, se dire Berlinois constitue la plus haute forme d'appartenance politique.",techniques:["Référence historique","Solidarité transculturelle","Gradation","Climax identitaire"]},
 {id:47,premium:true,title:"Discours d'Addis-Abeba",speaker:"Haïlé Sélassié",year:"1963",country:"",theme:"Panafricanisme",excerpt:"Sélassié prononce une prophétie morale : tant que la couleur de peau restera un critère de jugement des individus, les conflits humains persisteront, reliant le racisme et la guerre dans une équation éthique devenue universellement connue.",techniques:["Prophétie morale","Vision universelle","Pathos de la dignité","Reggae prophecy"]},
 {id:48,premium:true,title:"Discours de Pékin - Tiananmen",speaker:"Zhao Ziyang",year:"1989",country:"",theme:"Démocratie",excerpt:"Zhao Ziyang reconnaît avec émotion et humilité auprès des étudiants de Tiananmen qu'il arrive trop tard pour changer le cours des événements, dans ce qui sera sa dernière apparition publique avant sa disgrâce.",techniques:["Confession publique","Pathos de la défaite","Courage politique","Éthos du sacrifice"]},
 {id:49,premium:true,title:"Discours des femmes de Liberia",speaker:"Leymah Gbowee",year:"2003",country:"",theme:"Paix",excerpt:"Gbowee parle au nom des femmes libériennes épuisées par la guerre civile, affirmant que leurs corps et ceux de leurs enfants sont devenus le théâtre des violences, et exigeant que la paix soit immédiatement rétablie.",techniques:["Voix collective","Pathos corporel","Revendication directe","Sororité politique"]},
 {id:50,premium:true,title:"Blood, Toil, Tears and Sweat",speaker:"Winston Churchill",year:"1940",country:"",theme:"Guerre",excerpt:"Churchill promet honnêtement à la nation britannique non pas la facilité mais l'effort, les sacrifices et la guerre, substituant à tout réconfort illusoire une vérité brutale qui galvanise précisément par sa franchise absolue.",techniques:["Gravitas maximale","Honnêteté brutale","Gradation dramatique","Mobilisation nationale"]},
 {id:51,premium:true,title:"Discours de Bandung",speaker:"Jawaharlal Nehru",year:"1955",country:"",theme:"Non-alignement",excerpt:"Nehru affirme à Bandung la fin définitive de la tutelle européenne sur l'Asie et l'Afrique, proclamant que ces peuples tracent désormais leur propre voie selon leurs traditions et intérêts propres.",techniques:["Émancipation collective","Identité continentale","Rupture avec le colonialisme","Vision tiers-mondiste"]},
 {id:52,premium:true,title:"Discours du Mur de Berlin",speaker:"Ronald Reagan",year:"1987",country:"",theme:"Liberté",excerpt:"Reagan interpelle directement le dirigeant soviétique par son nom, l'enjoignant d'ouvrir la porte de Brandebourg et de démanteler le Mur de Berlin dans une injonction devenue symbole de la chute imminente du rideau de fer.",techniques:["Interpellation directe","Impératif symbolique","Pathos de la liberté","Image mémorable"]},
 {id:53,premium:true,title:"La force de la paix",speaker:"Rigoberta Menchú",year:"1992",country:"",theme:"Droits autochtones",excerpt:"Menchú inscrit son Prix Nobel dans un cadre collectif, affirmant que sa récompense est une victoire pour tous les peuples autochtones du monde et une reconnaissance de la valeur universelle de leur héritage culturel.",techniques:["Représentation collective","Éthos du peuple autochtone","Universalisme culturel","Dignité réparée"]},
 {id:54,premium:true,title:"Discours sur l'apartheid",speaker:"Desmond Tutu",year:"1984",country:"",theme:"Réconciliation",excerpt:"Tutu affirme que la fraternité universelle ancrée dans la foi transcende toute législation ségrégationniste, proclamant avec conviction que le mal de l'apartheid est condamné à l'échec par la loi morale supérieure.",techniques:["Fondement religieux","Logos moral","Résistance non-violente","Inéluctabilité éthique"]},
 {id:55,premium:true,title:"Discours de la libération de Paris",speaker:"Charles de Gaulle",year:"1944",country:"",theme:"Libération",excerpt:"De Gaulle célèbre la libération de Paris dans une anaphore en cinq temps qui monte de l'outrage vers la libération, transformant la souffrance de la capitale en récit de triomphe mémoriel.",techniques:["Anaphore géographique","Climax émotionnel","Gradation victoire","Pathos national"]},
 {id:56,premium:true,title:"Discours de Santiago",speaker:"Salvador Allende",year:"1973",country:"",theme:"Socialisme",excerpt:"Allende refuse la capitulation lors du coup d'État, affirmant que si les balles peuvent faire taire un homme, elles sont impuissantes à écraser les idées portées par des millions de personnes.",techniques:["Martyre politique","Idées immortelles","Éthos du combattant","Pathos de la mort annoncée"]},
 {id:57,premium:true,title:"Discours de Moscou - Glasnost",speaker:"Mikhaïl Gorbatchev",year:"1988",country:"",theme:"Réforme",excerpt:"Gorbatchev défend la nécessité d'une démocratie au sein du socialisme, affirmant que la glasnost — transparence et ouverture — est la condition pour que le système soviétique retrouve sa légitimité.",techniques:["Réforme depuis l'intérieur","Paradoxe socialiste","Légitimité institutionnelle","Rhétorique de l'ouverture"]},
 {id:58,premium:true,title:"Discours de Lagos - Nigeria",speaker:"Chinua Achebe",year:"1988",country:"",theme:"Identité africaine",excerpt:"Achebe diagnostique le problème central de l'Afrique non pas dans le manque de ressources mais dans l'absence de leaders capables de subordonner leurs intérêts personnels au bien commun de leurs peuples.",techniques:["Critique interne","Logos institutionnel","Éthos de l'intellectuel","Responsabilité collective"]},
 {id:59,premium:true,title:"Discours inaugural - ANC",speaker:"Oliver Tambo",year:"1969",country:"",theme:"Résistance",excerpt:"Tambo clarifie la nature de la résistance anti-apartheid : elle ne s'oppose pas à des individus selon leur couleur, mais au système institutionnel de ségrégation qu'il faut démanteler dans son intégralité.",techniques:["Distinction peuple/système","Clarté rhétorique","Éthos de l'exil","Appel à la résistance"]},
 {id:60,premium:true,title:"Discours de Libreville - Unité africaine",speaker:"Félix Houphouët-Boigny",year:"1965",country:"",theme:"Politique africaine",excerpt:"Houphouët-Boigny affirme que la paix constitue la richesse fondamentale sans laquelle aucun développement économique, aucune construction nationale, aucun espoir collectif ne peut prendre racine.",techniques:["Pacifisme pragmatique","Logos économique","Éthos du père de la nation","Simplicité efficace"]},
 {id:61,premium:true,title:"Discours de l'Élysée - Construction européenne",speaker:"Jacques Delors",year:"1985",country:"",theme:"Europe",excerpt:"Delors élargit la définition du projet européen au-delà du marché commun, affirmant que l'Europe est avant tout un projet de civilisation politique, culturelle et sociale à vocation historique.",techniques:["Élargissement de vision","Logos institutionnel","Éthos du constructeur","Identité européenne"]},
 {id:62,premium:true,title:"Discours de Gdansk - Solidarność",speaker:"Lech Wałęsa",year:"1980",country:"",theme:"Liberté du travail",excerpt:"Wałęsa articule les revendications ouvrières en une gradation simple : pain, dignité et liberté syndicale, refusant toute accusation d'utopisme pour revendiquer des droits fondamentaux concrets.",techniques:["Gradation des revendications","Éthos ouvrier","Pathos de la dignité","Sobriété percutante"]},
 {id:63,premium:true,title:"Discours pour la réconciliation irlandaise",speaker:"Mary Robinson",year:"1990",country:"",theme:"Réconciliation",excerpt:"Robinson s'engage dès son élection à représenter tous les Irlandais sans exception, symbolisant sa mission inclusive en tendant la main à ceux qui ont été historiquement marginalisés et exclus de la vie politique.",techniques:["Inclusion politique","Rhétorique de la main tendue","Éthos féminin pionnier","Vision nationale inclusive"]},
 {id:64,premium:true,title:"Discours à l'ONU sur le désarmement",speaker:"Olof Palme",year:"1982",country:"",theme:"Paix",excerpt:"Palme réinterprète la course aux armements comme une forme de guerre larvée contre les plus pauvres, chaque dépense militaire équivalant à des ressources soustraites au développement humain mondial.",techniques:["Syllogisme moral","Logos économique de la paix","Éthos nordique","Réinterprétation du conflit"]},
 {id:65,premium:true,title:"Discours du retour - De Gaulle",speaker:"Charles de Gaulle",year:"1958",country:"",theme:"Cinquième République",excerpt:"De Gaulle réaffirme sa conviction que la France reste un acteur central de l'Histoire et affirme qu'il est venu accomplir sa mission pour l'accompagner dans ce nouveau moment décisif de la vie nationale.",techniques:["Continuité historique","Éthos de la mission","Vision providentialiste","Sobriété solennelle"]},
 ...
 {id:67,premium:true,title:"Déclaration d'indépendance du Zimbabwe",speaker:"Robert Mugabe",year:"1980",country:"",theme:"Indépendance",excerpt:"Mugabe propose lors de l'indépendance du Zimbabwe de transformer l'ennemi d'hier en partenaire de demain, appelant à bâtir ensemble une nation libre et juste au-delà des antagonismes de la lutte armée.",techniques:["Retournement politique","Rhétorique de la réconciliation","Transition rhétorique","Vision inclusive post-coloniale"]},
 {id:68,premium:true,title:"Discours de Bandung II",speaker:"Soekarno",year:"1965",country:"",theme:"Tiers-monde",excerpt:"Soekarno proclame que les nations post-coloniales d'Asie et d'Afrique refusent d'être instrumentalisées dans les conflits des grandes puissances, affirmant leur souveraineté en refusant d'être de simples pions.",techniques:["Autonomisation collective","Identité post-coloniale","Logos géopolitique","Détermination souveraine"]},
 {id:69,premium:true,title:"Discours Nobel - Chimamanda Adichie",speaker:"Chimamanda Ngozi Adichie",year:"2015",country:"",theme:"Féminisme africain",excerpt:"Adichie formule une critique précise du système de genre : en prescrivant ce que les individus doivent être selon leur sexe, il efface ce qu'ils sont réellement, substituant le rôle imposé à l'identité authentique.",techniques:["Redéfinition conceptuelle","Éthos de l'écrivaine","Universalisme féministe","Précision analytique"]},
 ...
 {id:71,premium:true,title:"Discours du Coup d'État - Fidel Castro",speaker:"Fidel Castro",year:"1953",country:"",theme:"Révolution",excerpt:"Castro conclut sa plaidoirie en s'en remettant au jugement de l'Histoire plutôt qu'à celui du tribunal, affirmant sa conviction que les causes justes finissent toujours par triompher.",techniques:["Confiance prophétique","Éthos du martyr","Logos de l'histoire","Conviction révolutionnaire"]},
 {id:72,premium:true,title:"Discours à l'ONU sur la dette",speaker:"Fidel Castro",year:"1979",country:"",theme:"Économie mondiale",excerpt:"Castro interpelle l'Assemblée générale sur le scandale de la faim infantile mondiale, affirmant que les ressources existent pour l'éliminer si elles étaient réorientées de l'armement vers l'alimentation, la santé et l'éducation.",techniques:["Logos chiffré","Pathos de l'enfance","Accusation systémique","Rhétorique redistributive"]},
 {id:73,premium:true,title:"Discours de l'OUA - Unité",speaker:"Julius Nyerere",year:"1963",country:"",theme:"Panafricanisme",excerpt:"Nyerere pose l'unité africaine comme condition de survie géopolitique, non comme une métaphore romantique mais comme une nécessité concrète face à laquelle les dirigeants africains devront prendre position.",techniques:["Dilemme binaire","Urgence existentielle","Logos géopolitique","Vision continentale"]},
 {id:74,premium:true,title:"Discours pour l'égalité des genres - ONU",speaker:"Hillary Clinton",year:"1995",country:"",theme:"Droits des femmes",excerpt:"Clinton formule l'équivalence absolue entre droits des femmes et droits humains dans un chiasme délibéré, demandant que cette vérité soit enfin admise comme évidence et non plus soumise au débat.",techniques:["Équation rhétorique","Universalisme des droits","Concision percutante","Logos inclusif"]},
 ...
 {id:76,premium:true,title:"Discours de la Marche des femmes",speaker:"Angela Davis",year:"2017",country:"",theme:"Résistance",excerpt:"Davis plaide pour une vision intersectionnelle de la résistance politique, affirmant que la diversité des luttes exige des mouvements suffisamment larges et inclusifs pour les porter simultanément.",techniques:["Intersectionnalité","Logos militant","Appel à la diversité","Vision coalitionnaire"]},
 {id:77,premium:true,title:"Discours de Davos",speaker:"Greta Thunberg",year:"2020",country:"",theme:"Climat",excerpt:"Thunberg exhorte les dirigeants réunis à Davos à traiter l'urgence climatique avec la même immédiateté que s'ils voyaient leur propre maison en flammes, affirmant que cette métaphore est en réalité une description littérale.",techniques:["Métaphore d'urgence","Impératif radical","Pathos jeunesse","Répétition insistante"]},
 {id:78,premium:true,title:"Discours sur la désobéissance civile",speaker:"Aung San Suu Kyi",year:"1988",country:"",theme:"Démocratie",excerpt:"Aung San Suu Kyi définit la peur comme le principal obstacle à l'action démocratique, affirmant que surmonter cette peur plutôt que de céder aux excuses est la condition même de la liberté.",techniques:["Psychologie de la résistance","Logos moral","Éthos du courage","Défi à l'oppression"]},
 {id:79,premium:true,title:"Discours de Vienne sur les droits humains",speaker:"José Ayala-Lasso",year:"1993",country:"",theme:"Droits humains",excerpt:"Ayala-Lasso réfute l'accusation d'ethnocentrisme occidental adressée aux droits humains, affirmant qu'ils sont l'héritage universel de l'humanité entière, forgé dans la souffrance partagée de tous les peuples.",techniques:["Universalisme des droits","Réfutation de l'ethnocentrisme","Pathos de la souffrance","Vision inclusive"]},
 ...
 {id:81,premium:true,title:"Discours de la réunification allemande",speaker:"Helmut Kohl",year:"1990",country:"",theme:"Réunification",excerpt:"Kohl inscrit la réunification allemande parmi les moments les plus glorieux de l'histoire nationale, célébrant la réunion de deux peuples séparés par quarante ans de division idéologique.",techniques:["Historicisation du moment","Éthos du chancelier", "Vision nationale","Émotion sobre"]},
 {id:82,premium:true,title:"Discours de l'independence du Mozambique",speaker:"Samora Machel",year:"1975",country:"",theme:"Indépendance",excerpt:"Machel formule une équation politique sans compromis : l'existence du Mozambique indépendant exige l'élimination de l'impérialisme, affirmant que la liberté n'a pas été accordée mais conquise par la lutte armée.",techniques:["Antagonisme politique","Éthos révolutionnaire","Logos de la lutte armée","Rejet de la dépendance"]},
 {id:83,premium:true,title:"Discours aux Nations Unies - Nasser",speaker:"Gamal Abdel Nasser",year:"1956",country:"",theme:"Nationalisation",excerpt:"Nasser proclame la souveraineté égyptienne sur le canal de Suez, affirmant que cette ressource stratégique sera désormais exploitée au bénéfice du peuple égyptien plutôt qu'au profit des actionnaires étrangers.",techniques:["Souveraineté économique","Rupture nationaliste","Ethos du dirigeant fort","Simplification populiste"]},
 {id:84,premium:true,title:"Discours de Kinshasa - Ali vs Foreman",speaker:"Muhammad Ali",year:"1974",country:"",theme:"Identité et sport",excerpt:"Ali affirme avec une arrogance assumée sa présence et son identité face à ses détracteurs, proclamant qu'il va démontrer que l'excellence sportive est le fruit du travail et du talent, non de la chance.",techniques:["Affirmation identitaire","Éthos sportif","Défi direct","Pathos de la fierté"]},
 {id:85,premium:true,title:"Discours de Cancún - G77",speaker:"Indira Gandhi",year:"1981",country:"",theme:"Développement",excerpt:"Indira Gandhi refuse la fatalité des inégalités mondiales, affirmant que l'écart entre pays riches et pauvres n'est pas une donnée naturelle mais une injustice construite que la communauté internationale a le pouvoir de corriger.",techniques:["Réfutation du fatalisme","Logos de la justice distributive","Éthos du Sud global","Appel à l'action internationale"]},
 {id:86,premium:true,title:"Discours de l'élection présidentielle",speaker:"Nicolas Sarkozy",year:"2007",country:"",theme:"Politique française",excerpt:"Sarkozy interprète sa victoire électorale comme un mandat du peuple français pour le changement et le retour de la France dans la compétition internationale, inscrivant sa modernisation dans une logique de souveraineté regagnée.",techniques:["Légitimité populaire","Rhétorique de la compétition","Vision modernisatrice","Pathos de la victoire"]},
 {id:87,premium:true,title:"Discours de François Hollande au Vel d'Hiv",speaker:"François Hollande",year:"2012",country:"",theme:"Mémoire",excerpt:"Hollande reconnaît solennellement au nom de la France la responsabilité de l'État français dans la déportation des Juifs pendant l'Occupation, assumant l'irréparable au lieu de perpétuer le mythe de la France entièrement résistante.",techniques:["Reconnaissance mémorielle","Éthos présidentiel","Rupture avec le mythe gaulliste","Pathos de la honte partagée"]},
 {id:88,premium:true,title:"Discours de Varsovie - Droit international",speaker:"Boutros Boutros-Ghali",year:"1992",country:"",theme:"Paix internationale",excerpt:"Boutros-Ghali défend son Agenda pour la Paix comme une architecture institutionnelle réaliste et non comme un projet idéaliste, affirmant que la réduction de la violence organisée est un objectif concret et atteignable.",techniques:["Pragmatisme institutionnel","Logos diplomatique","Éthos onusien","Vision architecturale"]},
 {id:89,premium:true,title:"Discours de Stanford - Steve Jobs",speaker:"Steve Jobs",year:"2005",country:"",theme:"Innovation et vie",excerpt:"Jobs exhorte les diplômés de Stanford à conserver leur curiosité et leur audace, à ne jamais se laisser enfermer dans les conventions et la pensée des autres, formulant un appel à l'authenticité entrepreneuriale.",techniques:["Ethos d'entrepreneur visionnaire","Appel à l'individualisme","Ironie profonde","Mise en récit de sa vie"]},
 {id:90,premium:true,title:"Discours Nobel de la paix",speaker:"Aung San Suu Kyi",year:"1991",country:"",theme:"Démocratie",excerpt:"Aung San Suu Kyi affirme que la paix en Birmanie ne peut naître que de la vérité entendue, et demande aux nations libres d'accorder leur attention et leur soutien aux aspirations démocratiques du peuple birman.",techniques:["Voix du peuple silencieux","Éthos du combat","Logos de la vérité","Appel international"]},
 {id:91,premium:true,title:"Discours de l'Union africaine - Rwanda",speaker:"Paul Kagame",year:"2000",country:"",theme:"Reconstruction",excerpt:"Kagame propose une lecture morale du génocide rwandais : l'arme n'est pas la machette mais la haine qui la guide, et c'est donc la haine que la réconciliation doit combattre pour garantir que cela ne se reproduise pas.",techniques:["Diagnostic moral","Réinterprétation du génocide","Éthos de survivant","Vision réparatrice"]},
 {id:92,premium:true,title:"Discours inaugural du Sénégal",speaker:"Léopold Sédar Senghor",year:"1960",country:"",theme:"Négritude",excerpt:"Senghor revendique avec fierté son identité africaine et sénégalaise, affirmant que sa culture et son appartenance ne sont pas des fardeaux à surmonter mais des richesses à célébrer — au cœur de la pensée négritude.",techniques:["Affirmation identitaire","Renversement de la honte","Poésie politique","Éthos intellectuel"]},
 ...
 {id:94,premium:true,title:"Discours sur les réfugiés - UNHCR",speaker:"Filippo Grandi",year:"2022",country:"",theme:"Migration",excerpt:"Grandi cite le chiffre record de déplacements forcés dans le monde, transformant cette statistique en accusation morale et rappel que la responsabilité de cette crise est partagée par toute la communauté internationale.",techniques:["Chiffre comme accusation","Logos humanitaire","Responsabilité partagée","Urgence silencieuse"]},
 {id:95,premium:true,title:"Discours de l'Assemblée de la jeunesse africaine",speaker:"Alpha Condé",year:"2011",country:"",theme:"Jeunesse africaine",excerpt:"Alpha Condé affirme que le développement africain ne viendra ni des ONG ni des institutions financières internationales, mais uniquement des Africains eux-mêmes, et interpelle directement la jeunesse du continent.",techniques:["Responsabilisation de la jeunesse","Rupture avec l'aide","Éthos du dirigeant","Appel à l'autonomie"]},
 {id:96,premium:true,title:"Discours d'acceptation - Prix Nobel Littérature",speaker:"Toni Morrison",year:"1993",country:"",theme:"Langage & pouvoir",excerpt:"Morrison explore la dualité du langage : outil d'oppression subtile lorsqu'il impose des catégories, il peut devenir instrument de résistance lorsque ceux qui le parlent choisissent de le retourner contre les structures du pouvoir.",techniques:["Philosophie du langage","Éthos d'écrivaine noire","Pathos culturel","Vision libératrice"]},
 {id:97,premium:true,title:"Discours Evo Morales à l'ONU",speaker:"Evo Morales",year:"2006",country:"",theme:"Ressources naturelles",excerpt:"Morales proclame la souveraineté inaliénable du peuple bolivien sur les ressources naturelles du pays et s'engage à les restituer effectivement au peuple après des décennies d'exploitation par des intérêts privés.",techniques:["Nationalisme des ressources","Éthos indigène","Logos redistributif","Promesse solennelle"]},
 {id:98,premium:true,title:"Discours sur les droits autochtones",speaker:"Rigoberta Menchú",year:"2012",country:"",theme:"Droits autochtones",excerpt:"Menchú interroge le sens même du développement en posant la question de ce qui reste d'une civilisation millénaire si sa langue, sa culture et son territoire lui sont ôtés au nom du progrès économique.",techniques:["Logos de la longue durée","Remise en question du développement","Éthos autochtone","Pathos de la perte culturelle"]},
 {id:99,premium:true,title:"Discours de démission - Nixon",speaker:"Richard Nixon",year:"1974",country:"",theme:"Chute du pouvoir",excerpt:"Nixon reconnaît dans son discours de démission avoir cherché à servir le bien de la nation tout en commettant des erreurs, acceptant d'en assumer les conséquences politiques sans aller jusqu'à nommer explicitement ses fautes.",techniques:["Aveu indirect","Éthos de la dignité préservée","Logos auto-critique","Chute politique"]},
 {id:100,premium:true,title:"Discours pour la paix - ONU",speaker:"Kofi Annan",year:"2001",country:"",theme:"Paix mondiale",excerpt:"Annan redéfinit la paix au-delà des traités diplomatiques formels, la ramenant à la réalité concrète d'un enfant vivant sans peur, faisant de cette image humaine l'objectif ultime de l'action internationale.",techniques:["Redéfinition concrète","Pathos de l'enfance","Vision humaniste","Éthos du secrétaire général"]},
 {id:101,premium:true,title:"Discours de Nairobi - Environnement",speaker:"Wangari Maathai",year:"2004",country:"",theme:"Écologie",excerpt:"Maathai associe l'acte de planter un arbre à un acte politique et spirituel : geste de foi dans l'avenir et déclaration que demain existera, porté en particulier par les femmes africaines qu'elle a mobilisées.",techniques:["Métaphore végétale","Féminisme écologique","Vision concrète","Éthos de l'activiste"]},
 {id:102,premium:true,title:"Discours au Parlement européen - Brexit",speaker:"Nigel Farage",year:"2020",country:"",theme:"Souveraineté",excerpt:"Farage interpelle triomphalement le Parlement européen le jour du Brexit, affirmant que la plupart des parlementaires eurosceptiques quittent l'institution le sourire aux lèvres après des années passées à y siéger contre leur gré.",techniques:["Provocation délibérée","Ironie triomphante","Éthos anti-establishment","Rupture symbolique"]},
 {id:103,premium:true,title:"Discours de Tripoli - Révolution",speaker:"Mouammar Kadhafi",year:"1969",country:"",theme:"Révolution",excerpt:"Kadhafi proclame la prise de pouvoir par les forces révolutionnaires, annonçant la fin de la monarchie et de ceux qu'il qualifie de traîtres, dans un discours fondateur de son régime.",techniques:["Proclamation révolutionnaire","Rupture simple","Pathos de la libération","Rhétorique de rupture"]},
 {id:104,premium:true,title:"Discours pour la justice climatique",speaker:"Kumi Naidoo",year:"2019",country:"",theme:"Justice climatique",excerpt:"Naidoo réencadre le changement climatique comme une question de justice sociale plutôt qu'environnementale, soulignant l'injustice fondamentale par laquelle les populations les plus pauvres subissent la pollution des plus riches.",techniques:["Réencadrement politique","Logos de l'injustice","Éthos militant","Culpabilité transférée"]},
 ...
 {id:106,premium:true,title:"Discours de la victoire - Lula",speaker:"Luiz Inácio Lula da Silva",year:"2002",country:"",theme:"Démocratie sociale",excerpt:"Lula refuse de personnaliser sa victoire électorale, se définissant comme le porte-parole des classes populaires et des exclus dont la voix collective a pris le pouvoir, fils de pauvres devenu symbole de leur émancipation.",techniques:["Personnification populaire","Éthos du travailleur","Délégation symbolique","Pathos de la misère résolue"]},
 {id:107,premium:true,title:"Discours de la honte - Tshisekedi",speaker:"Étienne Tshisekedi",year:"1990",country:"",theme:"Démocratie congolaise",excerpt:"Tshisekedi affirme l'impossibilité désormais de réduire au silence l'opposition congolaise, s'en remettant au jugement de l'Histoire sur le régime en place et exprimant sa certitude d'en être du bon côté.",techniques:["Prophétie de l'histoire","Éthos du résistant","Courage politique","Confiance dans le jugement"]},
 ...
 {id:109,premium:true,title:"Discours de Berlin - Olaf Scholz",speaker:"Olaf Scholz",year:"2022",country:"",theme:"Sécurité européenne",excerpt:"Scholz qualifie l'invasion russe de l'Ukraine de tournant historique — Zeitenwende — et appelle l'Allemagne à assumer sa responsabilité particulière face à cette rupture de l'ordre sécuritaire européen.",techniques:["Mot allemand comme concept","Rupture historique","Éthos institutionnel","Appel à la responsabilité"]},
 {id:110,premium:true,title:"Discours au Parlement rwandais",speaker:"Kagame Paul",year:"2004",country:"",theme:"30 ans après le génocide",excerpt:"Kagame reformule le sens de la commémoration du génocide rwandais : non pas célébration de la mort mais affirmation de la survie, assortie d'une promesse collective et solennelle d'empêcher que cela se reproduise.",techniques:["Inversion de la commémoration","Promesse collective","Éthos de survivant","Formule universelle"]},
 {id:111,premium:true,title:"Discours de Genève - Droits humains",speaker:"Shirin Ebadi",year:"2003",country:"",theme:"Droits humains Islam",excerpt:"Ebadi sépare l'islam en tant que foi de ses interprétations patriarcales, affirmant que ce ne sont pas les textes sacrés mais leurs lectures instrumentalisées qui oppriment les femmes et contredisent les droits humains.",techniques:["Distinction religion/interprétation","Logos théologique","Éthos de femme musulmane","Réfutation apologétique"]},
 {id:112,premium:true,title:"Discours de Bruxelles - Sécurité cyber",speaker:"Ursula von der Leyen",year:"2023",country:"",theme:"Cybersécurité",excerpt:"Von der Leyen affirme que la dépendance technologique de l'Europe constitue une vulnérabilité stratégique, plaidant pour une souveraineté numérique qui est désormais une question de sécurité autant qu'économique.",techniques:["Souveraineté numérique","Urgence sécuritaire","Logos technologique","Éthos institutionnel"]},
 {id:113,premium:true,title:"Discours de jeunesse - Mandela",speaker:"Nelson Mandela",year:"1944",country:"",theme:"Militantisme",excerpt:"Mandela appelle sa génération à refuser de naturaliser l'injustice, affirmant que l'accepter serait une trahison de la mémoire de toutes celles et ceux qui ont sacrifié leur vie pour la combattre.",techniques:["Solidarité générationnelle","Obligation morale","Pathos de la filiation","Urgence d'agir"]},
 {id:114,premium:true,title:"Discours de la réconciliation - Mandela",speaker:"Nelson Mandela",year:"1993",country:"",theme:"Réconciliation",excerpt:"Mandela, après l'assassinat de Chris Hani, exhorte le pays à ne pas laisser le deuil se transformer en haine, mais à convertir cette douleur en force collective pour la paix et la transition démocratique.",techniques:["Transformation du deuil","Logos pacifiste","Maîtrise rhétorique","Leadership moral"]},
 {id:115,premium:true,title:"Discours de la colère juste - Zuma",speaker:"Jacob Zuma",year:"2009",country:"",theme:"Politique sud-africaine",excerpt:"Zuma affirme que la révolution politique post-apartheid est incomplète tant que les inégalités économiques héritées de la ségrégation persistent, plaçant l'émancipation économique au cœur de son mandat.",techniques:["Continuité révolutionnaire","Critique économique","Éthos post-apartheid","Mobilisation de la base"]},
 {id:116,premium:true,title:"Discours de la liberté - Haïti",speaker:"Jean-Bertrand Aristide",year:"1994",country:"",theme:"Démocratie haïtienne",excerpt:"Aristide formule son retour d'exil non comme un retour personnel au pouvoir mais comme le retour de la voix démocratique d'un peuple haïtien qui n'a jamais abandonné ses aspirations à la liberté.",techniques:["Retour symbolique","Éthos du peuple","Résistance ininterrompue","Pathos du retour"]},
 {id:117,premium:true,title:"Discours de Dakar - Mitterrand",speaker:"François Mitterrand",year:"1990",country:"",theme:"Démocratie en Afrique",excerpt:"Mitterrand lie explicitement la coopération française en Afrique à l'avancée vers la démocratie, posant une conditionnalité politique qui marque une rupture avec le soutien inconditionnel aux régimes africains amis.",techniques:["Conditionnalité rhétorique","Logos de la coopération","Engagement diplomatique","Universalisme républicain"]},
 {id:118,premium:true,title:"Discours de Strasbourg - Droits des peuples",speaker:"Jacques Chirac",year:"1997",country:"",theme:"Diversité culturelle",excerpt:"Chirac défend la diversité culturelle comme patrimoine universel de l'humanité, affirmant que la mondialisation économique ne doit pas se faire au prix de l'homogénéisation qui effacerait les identités particulières.",techniques:["Réencadrement culturel","Logos de la diversité","Éthique de la préservation","Ethos gaulliste"]},
 {id:119,premium:true,title:"Discours de Washington - Terrorisme",speaker:"George W. Bush",year:"2001",country:"",theme:"Antiterrorisme",excerpt:"Bush pose un ultimatum binaire à la communauté internationale après le 11 Septembre : soit soutenir la coalition américaine, soit être du côté des terroristes, éliminant toute nuance dans un monde divisé en deux camps.",techniques:["Faux dilemme délibéré","Logique binaire","Rhétorique de guerre","Mobilisation internationale"]},
 {id:120,premium:true,title:"Discours de Kobayé - Sacrifice",speaker:"Thomas Sankara",year:"1986",country:"",theme:"Sacrifice et développement",excerpt:"Sankara affirme que la formation politique et idéologique des soldats est une condition de leur humanité, avertissant qu'un combattant sans conscience révolutionnaire n'est pas un libérateur mais un criminel en puissance.",techniques:["Idéologie comme condition","Éthos révolutionnaire","Logos de la formation","Vision de la conscience"]},
 {id:121,premium:true,title:"Discours de l'accession - Macron",speaker:"Emmanuel Macron",year:"2017",country:"",theme:"Politique française",excerpt:"Macron s'engage dès son élection à gouverner pour l'ensemble des Français, y compris ceux qui ont voté contre lui, affirmant que sa seule ambition est le service de la nation au-delà des clivages partisans.",techniques:["Inclusion nationale","Promesse d'unité","Éthos de rupture","Universalisme républicain"]},
 {id:122,premium:true,title:"Discours de Yaoundé - Néocolonialisme",speaker:"Ahmadou Ahidjo",year:"1961",country:"",theme:"Indépendance économique",excerpt:"Ahidjo distingue indépendance politique et indépendance économique, affirmant que la première est acquise mais insuffisante, et que la véritable émancipation ne sera complète qu'avec la maîtrise des leviers économiques.",techniques:["Distinction politique/économique","Éthos du chef d'État","Logos du développement","Continuité de la lutte"]},
 {id:123,premium:true,title:"Discours de la solidarité nationale",speaker:"Angela Merkel",year:"2020",country:"",theme:"Covid-19",excerpt:"Merkel présente la pandémie de Covid-19 comme l'épreuve collective la plus grave depuis la Seconde Guerre mondiale, appelant à la solidarité nationale et affirmant que seule l'action commune permettra de surmonter la crise.",techniques:["Analogie historique","Appel à l'unité","Éthos de rigueur","Pathos de l'espoir"]},
 {id:124,premium:true,title:"Discours de Pretoria - Mandela 1990",speaker:"Nelson Mandela",year:"1990",country:"",theme:"Liberté retrouvée",excerpt:"Mandela ouvre son premier discours libre après 27 ans de prison en s'adressant simultanément à ses amis, ses camarades et tous les Sud-Africains, au nom d'une triple valeur fondatrice : la paix, la démocratie et la liberté pour tous.",techniques:["Triple invocation","Éthos du prisonnier libéré","Solennité simple","Rassemblement symbolique"]},
 {id:125,premium:true,title:"Discours d'acceptation - Barack Obama",speaker:"Barack Obama",year:"2012",country:"",theme:"Démocratie",excerpt:"Obama défend la démocratie dans son imperfection même : bruyante, désordonnée et frustrante, elle reste selon lui le seul système qui garantisse la liberté, et cette garantie vaut tous ses défauts.",techniques:["Défense de la démocratie imparfaite","Logos pragmatique","Pathos libéral","Éthos présidentiel"]},
];
const RHETORIC_DATA=[
